...
from tkprocess import __pkgname__, __description__, __version__
...
if __name__ == '__main__':
    setup(
        ...
        url='http://github.com/lishnih/tkprocess',
        platforms=['any'],
        keywords=['Tk', 'subprocess', 'threading'],
