...
def plot(input_ts='-',
    ...
    logx
        ...
        use '--xaxis="log"' instead.
    logy
        DEPRECATED:

        use '--yaxis="log"' instead.
    xlim
    ...
    norm_xaxis
        ...
        use '--type="norm_xaxis"' instead.
    norm_yaxis
        DEPRECATED:

        use '--type="norm_yaxis"' instead.
    lognorm_xaxis
        DEPRECATED:

        use '--type="lognorm_xaxis"' instead.
    lognorm_yaxis
        DEPRECATED:

        use '--type="lognorm_yaxis"' instead.
    xy_match_line : str
