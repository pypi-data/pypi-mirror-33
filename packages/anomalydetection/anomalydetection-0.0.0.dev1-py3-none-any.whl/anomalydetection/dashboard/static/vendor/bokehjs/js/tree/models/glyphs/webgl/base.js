...
var BaseGLGlyph = /** @class */ (function () {
    ...
    BaseGLGlyph.prototype.render = function (_ctx, indices, mainglyph) {
        // Get transform
        var _a = [0, 1, 2], a = _a[0], b = _a[1], c = _a[2];
        var wx = 1; // Weights to scale our vectors
        var wy = 1;
        var _b = this.glyph.renderer.map_to_screen([a * wx, b * wx, c * wx], [a * wy, b * wy, c * wy]), dx = _b[0], dy = _b[1];
        ...
        _c = this.glyph.renderer.map_to_screen([a * wx, b * wx, c * wx], [a * wy, b * wy, c * wy]), dx = _c[0], dy = _c[1];
