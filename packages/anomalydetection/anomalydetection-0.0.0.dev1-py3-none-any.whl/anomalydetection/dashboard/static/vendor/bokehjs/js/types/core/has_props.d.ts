...
declare const HasProps_base: {
    new (): {
        connect<Args, Sender extends object>(signal: Signal<Args, Sender>, slot: (() => void) | ((args: Args, sender: Sender) => void) | ((args: Args) => void)): boolean;
    };
};
export declare abstract class HasProps extends HasProps_base {
    ...
    mixins: string[];
    private static _fix_default(default_value, _attr);
