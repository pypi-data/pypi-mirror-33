...
__all__ = ['cache','dict_archive','null_archive','dir_archive',\
           ...
           'dataframe_archive'] #series_archive?
...
class dataframe_archive(dict): #XXX: or dataframe is parent?
    """dictionary-style interface to a pandas dataframe"""
    def __init__(self, name=None, column=None, **kwds):
        """initialize a dictionary interface to a dataframe

    Inputs:
        name: string name of the dataframe
        column: string name of the dataframe column
        serialized: if True, pickle contents; otherwise save python objects
        ...
        self.__state__ = {
            'name': name,
            'column': column,
            'serialized': kwds.get('serialized', False)
