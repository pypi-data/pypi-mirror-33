...
class Experiments(WMLResource):
    ...
    def list_definitions(self):
        ...
        self._client.repository.list_experiments()

    @docstring_parameter({'str_type': STR_TYPE_NAME})
    def get_definition_details(self, experiment_uid=None):
        """
        ...
        return self._client.repository.get_experiment_details(experiment_uid)
