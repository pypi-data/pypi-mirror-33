...
class TestWMLClientWithXGBoost(unittest.TestCase):
    ...
    def test_04_create_deployment(self):
        ...
        global deployment
        deployment = self.client.deployments.create(model_uid=self.model_uid, name="Test deployment", description='test description', asynchronous=False)
    ...
    def test_06_update_model_version(self):
        ...
        self.client.deployments.update(TestWMLClientWithXGBoost.deployment_uid, update_model_version=True)
