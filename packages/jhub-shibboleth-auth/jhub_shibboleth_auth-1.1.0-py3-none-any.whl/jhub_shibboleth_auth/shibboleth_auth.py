...
class ShibbolethLoginHandler(BaseHandler):
    ...
    async def get(self):
        ...
        # TODO i think after my pullR we done need this change
        # test if /jupyter/hub redirects to /jupyter/hub/login or not. if not, it is good, that means my PR worked!
        # test both on chrome and firefox, problem was on chrome!
