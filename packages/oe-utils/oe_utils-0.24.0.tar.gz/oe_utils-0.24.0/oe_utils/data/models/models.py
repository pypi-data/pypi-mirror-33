...
class WijzigingBase:
    def __init__(self):
        if not hasattr(self, '__tablename__'):
            raise Exception('No tablename was given. '
                            'Specify a __tablename__ attribute in your class that inherits from WijzigingBase.')
...
class Wijziging(WijzigingBase, Base):
    """
