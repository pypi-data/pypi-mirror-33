...
class KcpWrapper(_object):
    ...
    def setBindData(self, *args): return _kcp.KcpWrapper_setBindData(self, *args)
    def getBindData(self): return _kcp.KcpWrapper_getBindData(self)
    def setOutputListener(self, *args): return _kcp.KcpWrapper_setOutputListener(self, *args)
    def recv(self): return _kcp.KcpWrapper_recv(self)
    def send(self, *args): return _kcp.KcpWrapper_send(self, *args)
    def update(self, *args): return _kcp.KcpWrapper_update(self, *args)
    def check(self, *args): return _kcp.KcpWrapper_check(self, *args)
    def input(self, *args): return _kcp.KcpWrapper_input(self, *args)
    def flush(self): return _kcp.KcpWrapper_flush(self)
    def setMtu(self, *args): return _kcp.KcpWrapper_setMtu(self, *args)
    def setWndSize(self, *args): return _kcp.KcpWrapper_setWndSize(self, *args)
    def setNoDelay(self, *args): return _kcp.KcpWrapper_setNoDelay(self, *args)
    def getKcp(self): return _kcp.KcpWrapper_getKcp(self)
    def __disown__(self):
        self.this.disown()
...
class OutputListener(_object):
    ...
    __del__ = lambda self : None;
    def call(self, *args): return _kcp.OutputListener_call(self, *args)
    def __disown__(self):
        self.this.disown()
