...
_LISTDEVICESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='admobilize.devicemanagement.v1alpha1.ListDevicesRequest.page_size', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='admobilize.devicemanagement.v1alpha1.ListDevicesRequest.page_token', index=2,
...
_LISTDEVICESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='device', full_name='admobilize.devicemanagement.v1alpha1.ListDevicesResponse.device', index=0,
...
_LISTDEVICESRESPONSE.fields_by_name['device'].message_type = admobilize_dot_devicemanagement_dot_v1alpha1_dot_resources__pb2._DEVICE
...
_DEVICEMANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\023\"\021/v1alpha1/devices')),
  ),
  _descriptor.MethodDescriptor(
    name='GetDevice',
