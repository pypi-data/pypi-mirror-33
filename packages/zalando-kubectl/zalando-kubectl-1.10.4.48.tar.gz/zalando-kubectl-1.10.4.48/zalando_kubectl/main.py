...
KUBECTL_SHA256 = {
    'linux': '92ef1ab45e9564bf3225b7b08ada61cfb04d872f5d279cbb2d1781d8060fe83b',
    'darwin': 'bf4766b5998bff9cfffaed92c25ff6614b1297458b763dddd8e7412e54f9acf7'
}
...
def request_cluster_access(config, emergency, incident, user, reason):
    ...
    if emergency:
        ...
        make_manual_access_request(config, reason)
...
def make_manual_access_request(config, reason):
