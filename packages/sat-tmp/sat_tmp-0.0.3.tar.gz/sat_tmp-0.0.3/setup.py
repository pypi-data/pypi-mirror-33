...
setup(
    ...
    long_description=u'This module is used by Salut à Toi project to patch third party modules when the patches are not yet available upstream. Patches are removed from this module once merged upstream.',
    ...
    data_files=[(os.path.join(sys.prefix, 'share/doc', NAME),
                ['README', 'COPYING'])],
)
