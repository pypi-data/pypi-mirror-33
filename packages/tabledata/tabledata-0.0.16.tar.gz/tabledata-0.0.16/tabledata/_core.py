...
class TableData(object):
    ...
    def __equals_base(self, other):
        ...
        print(compare_item_list, self.header_list, other.header_list, file=sys.stderr)
    ...
    def __equals_dp(self, other):
        print("#!!!!!!", file=sys.stderr)
        if not self.__equals_base(other):
            print("__equals_base", file=sys.stderr)
            return False

        print(self.header_dp_list, file=sys.stderr)
        print(other.header_dp_list, file=sys.stderr)
