...
* utils/     - general purpose utilities and routines; the casual user will not need them.

If you use ISOFIT in your research or production, we simply ask that you
cite the precursor publication:

  David R. Thompson, Vijay Natraj, Robert O. Green, Mark Helmlinger, and Bo-Cai Gao, “Optimal Estimation for Imaging Spectrometer Atmospheric Correction.” *Remote Sensing of Environment* (in review).
