...
def custom_metrics_summary(name, value, count, host_tag, service_name, tags, tags_count):
    """
    ...
    :return:
    """
    CustomMetrics.summary(name, value, count, host_tag, service_name, tags, tags_count)


def custom_metrics_increment(name, count, host_tag, service_name, tags, tags_count):
    """
    The API provided to users to record custom metrics.
    :param name: str
    :param count: integer
    ...
    :return:
    """
    CustomMetrics.increment(name, count, host_tag, service_name, tags, tags_count)
...
class Context(object):
    ...
    def end_trace(self, event):  # Reports the last event in a trace
        ...
        url_tran = None if trans_name else Context.transaction_dict.get('url_tran', None)
