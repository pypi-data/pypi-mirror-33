...
class InputHandlerEventRequest(Request):
    ...
    :param events: 
    :type events: (optional) list[ask_sdk_model.services.game_engine.input_event.InputEvent]
    ...
    deserialized_types = {
        ...
        'timestamp': 'datetime',
        'locale': 'str',
        'events': 'list[ask_sdk_model.services.game_engine.input_event.InputEvent]'
    }
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, events=None):
        # type: (Optional[str], Optional[datetime], Optional[str], Optional[List[InputEvent]]) -> None
        """Sent when the conditions of an Echo Button event that your skill defined were met.
