...
class SessionEndedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, reason=None, error=None):  # noqa: E501
        ...
        super(SessionEndedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
        self.reason = reason
        self.error = error
