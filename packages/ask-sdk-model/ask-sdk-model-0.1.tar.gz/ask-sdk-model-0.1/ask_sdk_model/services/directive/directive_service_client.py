...
class DirectiveServiceClient(BaseServiceClient):
    ...
    def enqueue(self, send_directive_request, **kwargs):
        ...
        """
        Send directives to Alexa. # noqa: E501

        :param send_directive_request: (required) Represents the request object to send in the payload. # noqa: E501
        ...
        error_definitions = []
        error_definitions.append(ServiceClientResponse(response_type=None, status_code=204, message="Directive sent successfully."))  # noqa: E501
        error_definitions.append(ServiceClientResponse(response_type="ask_sdk_model.services.directive.error.Error", status_code=400, message="Directive not valid."))  # noqa: E501
        error_definitions.append(ServiceClientResponse(response_type="ask_sdk_model.services.directive.error.Error", status_code=401, message="Not Authorized."))  # noqa: E501
        error_definitions.append(ServiceClientResponse(response_type="ask_sdk_model.services.directive.error.Error", status_code=403, message="The skill is not allowed to send directives at the moment."))  # noqa: E501
        error_definitions.append(ServiceClientResponse(response_type="ask_sdk_model.services.directive.error.Error", status_code=0, message="Unexpected error."))  # noqa: E501
