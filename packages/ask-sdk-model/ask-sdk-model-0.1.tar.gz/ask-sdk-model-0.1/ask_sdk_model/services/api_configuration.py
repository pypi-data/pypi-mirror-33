...
class ApiConfiguration(object):
    ...
    :type serializer: (optional) :py:class:`ask_sdk_model.services.serializer.Serializer`
    :param api_client: API Client implementation
    :type api_client: (optional) :py:class:`ask_sdk_model.services.api_client.ApiClient`
    :param authorization_value: Authorization value to be used on any calls of the service client instance # noqa: E501
