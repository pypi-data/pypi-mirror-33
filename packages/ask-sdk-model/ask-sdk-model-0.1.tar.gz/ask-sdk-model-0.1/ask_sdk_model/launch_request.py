...
class LaunchRequest(Request):
    """
    Represents that a user made a request to an Alexa skill, but did not provide a specific intent.  # noqa: E501
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None):  # noqa: E501
        ...
        super(LaunchRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
