...
class Context(object):
    ...
    :param system: Provides information about the current state of the Alexa service and the device interacting with your skill.  # noqa: E501
    :type system: (optional) ask_sdk_model.interfaces.system.system_state.SystemState
    :param audio_player: Provides the current state for the AudioPlayer interface.  # noqa: E501
    :type audio_player: (optional) ask_sdk_model.interfaces.audioplayer.audio_player_state.AudioPlayerState
    :param display: Provides the current state for the Display interface.  # noqa: E501
    ...
    def __init__(self, system=None, audio_player=None, display=None):  # noqa: E501
