...
class ConnectionsResponse(Request):
    """
    This is the request object that a skill will receive as a result of Connections.SendResponse directive from referrer skill.  # noqa: E501
    ...
    :param name: Name of the action for which response is received.  # noqa: E501
    :type name: (optional) str
    :param payload: This is an object sent from referrer skill as is.  # noqa: E501
    :type payload: (optional) dict(str, object)
    :param token: This is the token that the skill originally sent with the ConnectionsSendRequest directive.  # noqa: E501
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, status=None, name=None, payload=None, token=None):  # noqa: E501
        ...
        super(ConnectionsResponse, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
        self.status = status
        self.name = name
