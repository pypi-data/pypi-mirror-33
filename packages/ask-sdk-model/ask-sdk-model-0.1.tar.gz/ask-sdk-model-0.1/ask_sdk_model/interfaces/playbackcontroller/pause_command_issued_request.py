...
class PauseCommandIssuedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None):  # noqa: E501
        ...
        super(PauseCommandIssuedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
