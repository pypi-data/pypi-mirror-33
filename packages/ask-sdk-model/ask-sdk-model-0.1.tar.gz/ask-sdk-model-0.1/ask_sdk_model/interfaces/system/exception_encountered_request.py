...
class ExceptionEncounteredRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, error=None, cause=None):  # noqa: E501
        ...
        super(ExceptionEncounteredRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
        self.error = error
        self.cause = cause
