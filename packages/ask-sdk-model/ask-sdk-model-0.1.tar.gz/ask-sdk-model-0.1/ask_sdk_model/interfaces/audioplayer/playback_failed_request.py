...
class PlaybackFailedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, current_playback_state=None, error=None, token=None):  # noqa: E501
        ...
        super(PlaybackFailedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
