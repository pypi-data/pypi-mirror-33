...
class PlaybackNearlyFinishedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, offset_in_milliseconds=None, token=None):  # noqa: E501
        ...
        super(PlaybackNearlyFinishedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
