...
class InputHandlerEventRequest(Request):
    """
    Sent when the conditions of an Echo Button event that your skill defined were met.  # noqa: E501
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, events=None):  # noqa: E501
        ...
        super(InputHandlerEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
        self.events = events
