...
class BodyTemplate3(Template):
    ...
    def __init__(self, token=None, back_button=None, background_image=None, image=None, title=None, text_content=None):  # noqa: E501
        ...
        super(BodyTemplate3, self).__init__(object_type=self.__discriminator_value, token=token, back_button=back_button)  # noqa: E501
