...
class ElementSelectedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, token=None):  # noqa: E501
        ...
        super(ElementSelectedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
        self.token = token
