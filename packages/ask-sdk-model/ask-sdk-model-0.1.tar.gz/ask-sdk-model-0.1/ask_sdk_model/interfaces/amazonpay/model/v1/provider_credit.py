...
class ProviderCredit(object):
    ...
    :param provider_id: This is required only for Ecommerce provider (Solution provider) use cases.  # noqa: E501
    ...
    def __init__(self, provider_id=None, credit=None):  # noqa: E501
