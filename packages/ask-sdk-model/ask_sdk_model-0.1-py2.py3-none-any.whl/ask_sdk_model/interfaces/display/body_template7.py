...
class BodyTemplate7(Template):
    ...
    def __init__(self, token=None, back_button=None, title=None, image=None, background_image=None):  # noqa: E501
        ...
        super(BodyTemplate7, self).__init__(object_type=self.__discriminator_value, token=token, back_button=back_button)  # noqa: E501
        self.title = title
        self.image = image
