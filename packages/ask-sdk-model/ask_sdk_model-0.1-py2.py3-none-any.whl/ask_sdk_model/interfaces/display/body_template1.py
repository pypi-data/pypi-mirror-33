...
class BodyTemplate1(Template):
    ...
    def __init__(self, token=None, back_button=None, background_image=None, title=None, text_content=None):  # noqa: E501
        ...
        super(BodyTemplate1, self).__init__(object_type=self.__discriminator_value, token=token, back_button=back_button)  # noqa: E501
