...
class SendResponseDirective(Directive):
    """
    This is the directive that a skill can send as part of their response to a session based request to return a response to ConnectionsRequest.  # noqa: E501

    NOTE: This class is auto generated.
    Do not edit the class manually.

    :type status: (optional) ask_sdk_model.interfaces.connections.connections_status.ConnectionsStatus
    :param payload: This is an object sent to referrer skill as is.  # noqa: E501
    ...
    def __init__(self, status=None, payload=None):  # noqa: E501
        ...
        super(SendResponseDirective, self).__init__(object_type=self.__discriminator_value)  # noqa: E501
        self.status = status
