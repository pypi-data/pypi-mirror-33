...
class MessageReceivedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, message=None):  # noqa: E501
        ...
        super(MessageReceivedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
