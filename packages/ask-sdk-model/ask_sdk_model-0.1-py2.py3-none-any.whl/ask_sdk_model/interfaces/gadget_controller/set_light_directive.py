...
class SetLightDirective(Directive):
    """
    Sends Alexa a command to modify the behavior of connected Echo Buttons.  # noqa: E501

    NOTE: This class is auto generated.
    Do not edit the class manually.

    :param version: The version of the directive. Must be set to 1.  # noqa: E501
    :type version: (optional) int
    :param target_gadgets: The gadget IDs that will receive the command. An empty array, or leaving this parameter out, signifies that all gadgets will receive the command.  # noqa: E501
    ...
    def __init__(self, version=None, target_gadgets=None, parameters=None):  # noqa: E501
        ...
        super(SetLightDirective, self).__init__(object_type=self.__discriminator_value)  # noqa: E501
