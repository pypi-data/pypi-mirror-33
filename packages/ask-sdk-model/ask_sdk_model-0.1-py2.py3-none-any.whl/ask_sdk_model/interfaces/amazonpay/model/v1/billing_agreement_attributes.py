...
class BillingAgreementAttributes(object):
    """
    The merchant can choose to set the attributes specified in the BillingAgreementAttributes.  # noqa: E501

    NOTE: This class is auto generated.
    Do not edit the class manually.

    :param platform_id: Represents the SellerId of the Solution Provider that developed the eCommerce platform. This value is only used by Solution Providers, for whom it is required. It should not be provided by merchants creating their own custom integration. Do not specify the SellerId of the merchant for this request parameter. If you are a merchant, do not enter a PlatformId.  # noqa: E501
    :type platform_id: (optional) str
    :param seller_note: Represents a description of the billing agreement that is displayed in emails to the buyer.  # noqa: E501
    ...
    def __init__(self, platform_id=None, seller_note=None, seller_billing_agreement_attributes=None):  # noqa: E501
