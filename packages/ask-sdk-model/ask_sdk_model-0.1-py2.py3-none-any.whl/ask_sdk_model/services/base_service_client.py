...
class BaseServiceClient(object):
    ...
    :type api_configuration: :py:class:`ask_sdk_model.services.api_configuration.ApiConfiguration`
    """
    ...
    def invoke(
        ...
        :type response_definitions: List(:py:class:`ask_sdk_model.services.service_client_response.ServiceClientResponse`) # noqa: E501
