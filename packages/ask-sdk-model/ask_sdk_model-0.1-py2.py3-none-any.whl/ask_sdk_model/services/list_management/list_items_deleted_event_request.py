...
class ListItemsDeletedEventRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, body=None):  # noqa: E501
        ...
        super(ListItemsDeletedEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)  # noqa: E501
        self.body = body
