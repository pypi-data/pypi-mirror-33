...
class AlexaListItem(object):
    ...
    :param href: URL to retrieve the item from.  # noqa: E501
    ...
    def __init__(self, id=None, version=None, value=None, status=None, created_time=None, updated_time=None, href=None):  # noqa: E501
