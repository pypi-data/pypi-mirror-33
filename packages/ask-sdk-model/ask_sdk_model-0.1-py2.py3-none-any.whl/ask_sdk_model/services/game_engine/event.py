...
class Event(object):
    """
    The events object is where you define the conditions that must be met for your skill to be notified of Echo Button input. You must define at least one event.  # noqa: E501

    NOTE: This class is auto generated.
    Do not edit the class manually.

    :param should_end_input_handler: Whether the Input Handler should end after this event fires. If true, the Input Handler will stop and no further events will be sent to your skill unless you call StartInputHandler again.  # noqa: E501
    ...
    :param maximum_invocations: Enables you to limit the number of times that the skill is notified about the same event during the course of the Input Handler. The default value is 1. This property is mutually exclusive with triggerTimeMilliseconds.   # noqa: E501
    :type maximum_invocations: (optional) int
    :param trigger_time_milliseconds: Adds a time constraint to the event. Instead of being considered whenever a raw button event occurs, an event that has this parameter will only be considered once at triggerTimeMilliseconds after the Input Handler has started. Because a time-triggered event can only fire once, the maximumInvocations value is ignored. Omit this property entirely if you do not want to time-constrain the event.   # noqa: E501
    ...
    def __init__(self, should_end_input_handler=None, meets=None, fails=None, reports=None, maximum_invocations=None, trigger_time_milliseconds=None):  # noqa: E501
