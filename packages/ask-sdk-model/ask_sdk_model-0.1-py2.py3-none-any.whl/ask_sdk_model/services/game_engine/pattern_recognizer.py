...
class PatternRecognizer(Recognizer):
    """
    This recognizer is true when all of the specified events have occurred in the specified order.  # noqa: E501
    ...
    :param fuzzy: When true, the recognizer will ignore additional events that occur between the events specified in the pattern.  # noqa: E501
    :type fuzzy: (optional) bool
    :param gadget_ids: The gadget IDs of the Echo Buttons to consider in this pattern recognizer.  # noqa: E501
    :type gadget_ids: (optional) list[str]
    :param actions: The actions to consider in this pattern recognizer. All other actions will be ignored.  # noqa: E501
    :type actions: (optional) list[str]
    :param pattern: An object that provides all of the events that need to occur, in a specific order, for this recognizer to be true. Omitting any parameters in this object means \&quot;match anything\&quot;.  # noqa: E501
    ...
    def __init__(self, anchor=None, fuzzy=None, gadget_ids=None, actions=None, pattern=None):  # noqa: E501
        ...
        super(PatternRecognizer, self).__init__(object_type=self.__discriminator_value)  # noqa: E501
        self.anchor = anchor
        self.fuzzy = fuzzy
