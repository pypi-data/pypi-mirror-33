...
class InputHandlerEvent(object):
    ...
    :param name: The name of the event as you defined it in your GameEngine.StartInputHandler directive.  # noqa: E501
    :type name: (optional) str
    :param input_events: A chronologically ordered report of the raw Button Events that contributed to this Input Handler Event.  # noqa: E501
    ...
    def __init__(self, name=None, input_events=None):  # noqa: E501
