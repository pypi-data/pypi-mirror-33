...
class SupportedInterfaces(object):
    """
    An object listing each interface that the device supports. For example, if supportedInterfaces includes AudioPlayer {}, then you know that the device supports streaming audio using the AudioPlayer interface.  # noqa: E501
    ...
    def __init__(self, audio_player=None, display=None, video_app=None):  # noqa: E501
