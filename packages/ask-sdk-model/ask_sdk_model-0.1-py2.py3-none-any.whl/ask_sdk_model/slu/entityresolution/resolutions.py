...
class Resolutions(object):
    """
    Represents the results of resolving the words captured from the user&#39;s utterance. This is included for slots that use a custom slot type or a built-in slot type that you have extended with your own values. Note that resolutions is not included for built-in slot types that you have not extended.  # noqa: E501
    ...
    def __init__(self, resolutions_per_authority=None):  # noqa: E501
