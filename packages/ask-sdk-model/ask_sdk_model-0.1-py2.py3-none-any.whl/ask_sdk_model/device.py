...
class Device(object):
    """
    An object providing information about the device used to send the request. The device object contains both deviceId and supportedInterfaces properties. The deviceId property uniquely identifies the device. The supportedInterfaces property lists each interface that the device supports. For example, if supportedInterfaces includes AudioPlayer {}, then you know that the device supports streaming audio using the AudioPlayer interface.  # noqa: E501

    NOTE: This class is auto generated.
    Do not edit the class manually.

    :param device_id: The deviceId property uniquely identifies the device.  # noqa: E501
    :type device_id: (optional) str
    :param supported_interfaces: Lists each interface that the device supports. For example, if supportedInterfaces includes AudioPlayer {}, then you know that the device supports streaming audio using the AudioPlayer interface  # noqa: E501
    ...
    def __init__(self, device_id=None, supported_interfaces=None):  # noqa: E501
