...
#This function simply outputs an arrayInfo.txt file within a GLDS_path
def detect_array(GLDS_path):
    R_script = os.path.join(config.R_dir,'affyNormQC.R')
    R_command = ["Rscript", R_script, "-i", rawdata_out,"--arrayInfoOnly=TRUE"]
...
#This function renames rawdata files (taken from metadata) into standardized format
...
#This function runs the qc and normalization R scripts
...
#This function runs the differential expression R script that uses limma
