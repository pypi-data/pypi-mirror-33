...
class MLB(API):
    ...
    def get_daily_boxscore(self, year, month, day):
        ...
        """
        path = "lb/trial/v6.5/en/games/{year:4d}/{month:02d}/{day:02d}/boxscore".format(
    ...
    def get_daily_change_log(self, year, month, day):
        ...
        """
        path = "lb/trial/v6.5/en/league/{year:4d}/{month:02d}/{day:02d}/changes".format(
            year=year, month=month, day=day)
        print(path)
        return self._make_request(path)
    ...
    def get_daily_schedule(self, year, month, day):
        """Obtain Schedule for the MLB for a given day. NOTE: The 2012 sample data is an
            abbreviated season.
        """
        path = "lb/trial/v6.5/en/games/{year:4d}/{month:02d}/{day:02d}/schedule".format(
            year=year, month=month, day=day)
        print(path)
        return self._make_request(path)
    ...
    def get_daily_summary(self, year, month, day):
        ...
        """
        path = "lb/trial/v6.5/en/games/{year:4d}/{month:02d}/{day:02d}/summary".format(
            year=year, month=month, day=day)
        print(path)
        return self._make_request(path)
    ...
    def get_daily_transactions(self, year, month, day):
        """Obtain information concerning all transactions taking place on a given MLB
            defined day.
        """
        path = "lb/trial/v6.5/en/league/{year:4d}/{month:02d}/{day:02d}/transactions".format(
            year=year, month=month, day=day)
        print(path)
        return self._make_request(path)
    ...
    def get_game_boxscore(self, event_id):
        ...
        path = "lb/trial/v6.5/en/games/{event_id}/boxscore".format(event_id=event_id)
        print(path)
        return self._make_request(path)

    def get_game_pitch_metrics(self, event_id):
        """Obtain pitch metrics for a specific MLB game."""
        path = "lb/trial/v6.5/en/games/{event_id}/pitch_metrics".format(
            event_id=event_id)
        print(path)
        return self._make_request(path)
    ...
    def get_game_summary(self, event_id):
        ...
        path = "lb/trial/v6.5/en/games/{event_id}/summary".format(event_id=event_id)
        print(path)
        return self._make_request(path)
    ...
    def get_league_schedule(self, year, mlb_season):
        """Obtain Schedule for the MLB for a given season. NOTE: The 2012 sample data is
            an abbreviated season.
        """
        path = "lb/trial/v6.5/en/games/{year:4d}/{mlb_season}/schedule".format(
            year=year, mlb_season=mlb_season)
        print(path)
        return self._make_request(path)

    def get_play-by-play(self, event_id):
        """Obtain the play-by-play data for a specific MLB game."""
        path = "lb/trial/v6.5/en/games/{event_id}/pbp".format(event_id=event_id)
        print(path)
        return self._make_request(path)

    def get_player_profile(self, player_id):
        """Obtain a profile for a given player."""
        path = "lb/trial/v6.5/en/players/{player_id}/profile".format(
            player_id=player_id)
        print(path)
        return self._make_request(path)
    ...
    def get_rankings(self, year, mlb_season):
        ...
        """
        path = "lb/trial/v6.5/en/seasons/{year:4d}/{mlb_season}/rankings".format(
            year=year, mlb_season=mlb_season)
        print(path)
        return self._make_request(path)
    ...
    def get_seasonal_pitch_metrics(self, player_id):
        ...
        path = "lb/trial/v6.5/en/players/{player_id}/pitch_metrics".format(
            player_id=player_id)
        print(path)
        return self._make_request(path)
    ...
    def get_seasonal_splits(self, year, mlb_season, team_id):
        ...
        path = "lb/trial/v6.5/en/seasons/{year:4d}/{mlb_season}/teams/{team_id}/splits".format(
    ...
    def get_seasonal_statistics(self, year, mlb_season, team_id):
        ...
        path = "lb/trial/v6.5/en/seasons/{year:4d}/{mlb_season}/teams/{team_id}/statistics".format(
            year=year, mlb_season=mlb_season, team_id=team_id)
        print(path)
        return self._make_request(path)
    ...
    def get_seasonal_transactions(self, year):
        """Obtain information concerning all transactions taking place during a given
            season.
        """
        path = "lb/trial/v6.5/en/league/{year:4d}/transactions".format(year=year)
        print(path)
        return self._make_request(path)

    def get_series_schedule(self, year, mlb_season):
        """Obtain Series Schedule for the MLB for the postseason."""
        path = "lb/trial/v6.5/en/series/{year:4d}/{mlb_season}/schedule".format(
            year=year, mlb_season=mlb_season)
        print(path)
        return self._make_request(path)
    ...
    def get_series_statistics(self, series_id, team_id):
        ...
        """
        path = "lb/trial/v6.5/en/series/{series_id}/teams/{team_id}/statistics".format(
    ...
    def get_series_summary(self, series_id):
        """Obtain series summary info for a given series. Please note that this feed will
            not return data until the 2017 playoffs begin
        """
        path = "lb/trial/v6.5/en/series/{series_id}/summary".format(
            series_id=series_id)
        print(path)
        return self._make_request(path)
    ...
    def get_standings(self, year, mlb_season):
        ...
        """
        path = "lb/trial/v6.5/en/seasons/{year:4d}/{mlb_season}/standings".format(
            year=year, mlb_season=mlb_season)
        print(path)
        return self._make_request(path)
    ...
    def get_team_depth_chart(self, team_id):
        ...
        path = "lb/trial/v6.5/en/teams/{team_id}/depth_ch".format(team_id=team_id)
        print(path)
        return self._make_request(path)

    def get_team_profile(self, team_id):
        """Obtain team profile information."""
        path = "lb/trial/v6.5/en/teams/{team_id}/profile".format(team_id=team_id)
        print(path)
        return self._make_request(path)

    def get_venues(self):
        """Obtain venue data for the current season."""
        path = "lb/trial/v6.5/en/league/venues".format()
        print(path)
        return self._make_request(path)
