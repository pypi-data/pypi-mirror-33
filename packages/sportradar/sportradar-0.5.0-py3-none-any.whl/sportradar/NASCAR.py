...
class NASCAR(API):
    ...
    def get_drivers(self, nascar_series, year):
        """Obtain driver information for NASCAR. NOTE: The 2012 sample data is an
            abbreviated season
        """
        path = "nascar-ot3/{nascar_series}/{year:4d}/drivers/lis".format(
    ...
    def get_tracks(self):
        """Obtain track information for NASCAR. NOTE: The 2012 sample data is an
            abbreviated season
        """
        path = "nascar-ot3/tracks/lis".format()
        print(path)
        return self._make_request(path)
    ...
    def get_entry_list(self, nascar_series, race_id):
        """Obtain entry list information for NASCAR. NOTE: The 2012 sample data is an
            abbreviated season
        """
        path = "nascar-ot3/{nascar_series}/races/{race_id}/entry_lis".format(
    ...
    def get_driver,_rookie,_owner,_and_manufacturer_standings(self, nascar_series, year, standings_type):
