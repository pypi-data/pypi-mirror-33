...
class NHL(API):
    ...
    def get_league_leaders_-_goaltending(self, season, nhl_season):
    ...
    def get_league_leaders_-_skaters(self, season, nhl_season):
    ...
    def get_league_leaders_-_daily(self, year1, nhl_season, year2, month, day):
    ...
    def get_league_leaders_-_seasonal(self, season, nhl_season):
    ...
    def get_seasonal_statistics_-_season_to_date(self, season, nhl_season, team_id):
    ...
    def get_team_leaders_-_daily(self, year1, nhl_season, year2, month, day, team_id):
        """Provides the leaders for a given day. Please note that this feed will not
            return data until the regular season begins
        """
    ...
    def get_team_leaders_-_seasonal(self, season, nhl_season, team_id):
    ...
    def get_team_profile_-_roster(self, team_id):
