...
class Tennis(API):
    ...
    def get_daily_results(self, year, month, day):
        """Provides match information and scoring, for all matches played on a given da
            y
        """
        path = "ennis-t2/en/schedules/{year:4d}-{month:02d}-{day:02d}/results".format(
    ...
    def get_daily_schedule(self, year, month, day):
        ...
        path = "ennis-t2/en/schedules/{year:4d}-{month:02d}-{day:02d}/schedule".format(
            year=year, month=month, day=day)
        print(path)
        return self._make_request(path)
    ...
    def get_deleted_matches(self):
        ...
        path = "ennis-t2/en/schedules/deleted_matches".format()
        print(path)
        return self._make_request(path)

    def get_match_probabilities(self, match_id):
        """Provides match probabilities"""
        path = "ennis-t2/en/matches/{match_id}/probabilities".format(match_id=match_id)
        print(path)
        return self._make_request(path)

    def get_match_summary(self, match_id):
        """Provides match summary, including scores and statistics"""
        path = "ennis-t2/en/matches/{match_id}/summary".format(match_id=match_id)
        print(path)
        return self._make_request(path)

    def get_match_timeline(self, match_id):
        """Provides match information and scoring"""
        path = "ennis-t2/en/matches/{match_id}/timeline".format(match_id=match_id)
        print(path)
        return self._make_request(path)

    def get_player_profile(self, player_id):
        """Provides player information"""
        path = "ennis-t2/en/players/{player_id}/profile".format(player_id=player_id)
        print(path)
        return self._make_request(path)

    def get_player_versus_player(self, player_id_1, player_id_2):
        """Provides information on team versus team results"""
        path = "ennis-t2/en/players/{player_id_1}/versus/{player_id_2}/matches".format(
    ...
    def get_player_results(self, player_id):
        ...
        path = "ennis-t2/en/players/{player_id}/results".format(player_id=player_id)
        print(path)
        return self._make_request(path)

    def get_player_schedule(self, player_id):
        """Provides the schedule for a player"""
        path = "ennis-t2/en/players/{player_id}/schedule".format(player_id=player_id)
        print(path)
        return self._make_request(path)

    def get_player_rankings(self):
        """Provides player rankings for a given tournaments"""
        path = "ennis-t2/en/players/rankings".format()
        print(path)
        return self._make_request(path)

    def get_player_race_rankings(self):
        """Provides player rankings for a given tournaments"""
        path = "ennis-t2/en/players/race_rankings".format()
        print(path)
        return self._make_request(path)

    def get_double-team_profile(self, team_id):
        """Team information, including player roster information"""
        path = "ennis-t2/en/double_teams/{team_id}/profile".format(team_id=team_id)
        print(path)
        return self._make_request(path)

    def get_double-team_results(self, team_id):
        """Provides a Team's Results"""
        path = "ennis-t2/en/double_teams/{team_id}/results".format(team_id=team_id)
        print(path)
        return self._make_request(path)

    def get_double-team_schedule(self, team_id):
        """Provides a Team's Schedule"""
        path = "ennis-t2/en/double_teams/{team_id}/schedule".format(team_id=team_id)
        print(path)
        return self._make_request(path)

    def get_double_team_versus_team(self, team_id_1, team_id_2):
        """Provides information on team versus team results"""
        path = "ennis-t2/en/double_teams/{team_id_1}/versus/{team_id_2}/matches".format(
    ...
    def get_doubles_rankings(self):
        ...
        path = "ennis-t2/en/double_teams/rankings".format()
        print(path)
        return self._make_request(path)

    def get_doubles_race_rankings(self):
        """Provides double rankings for a Doubles"""
        path = "ennis-t2/en/double_teams/race_rankings".format()
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_info(self, tournament_id):
        """Provide information for a given Tournament found in the Tournament List
            endpoint
        """
        path = "ennis-t2/en/tournaments/{tournament_id}/in".format(
    ...
    def get_tournament_list(self):
        ...
        path = "ennis-t2/en/tournaments".format()
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_ongoing(self):
        """Provides updated information for a given Tournament found in the Tournament
            List endpoint
        """
        path = "ennis-t2/en/tournaments/ongoing".format()
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_results(self, tournament_id):
        """Provides results for a given Tournament found in the Tournament List en
            dpoint
        """
        path = "ennis-t2/en/tournaments/{tournament_id}/results".format(
            tournament_id=tournament_id)
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_schedule(self, tournament_id):
        """Provides the schedule for a given Tournament found in the Tournament List
            endpoint
        """
        path = "ennis-t2/en/tournaments/{tournament_id}/schedule".format(
            tournament_id=tournament_id)
        print(path)
        return self._make_request(path)
