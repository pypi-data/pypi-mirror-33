...
import os
import numpy as np
print("Welcon to use TGFaceRecognition, you only need to designate the path of your image folder by use TGFace.imgfoler=path. Then you can run TGFace.TGFace(TGFace.imgfolder) to recognize.")
imgfolder=None
def TGFace(imafolder):
