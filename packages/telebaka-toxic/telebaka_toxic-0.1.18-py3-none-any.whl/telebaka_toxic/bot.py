...
def setup(dispatcher):
    ...
    toxic_callback = partial(stats, bot_instance=dispatcher.bot_instance)
    regex_callback = partial(stats, bot_instance=dispatcher.bot_instance)
    ...
    dispatcher.add_handler(MessageHandler(Filters.text, regex_callback))
    return dispatcher
