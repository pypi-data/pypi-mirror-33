...
def __compute_siphash(key, data, output_length, c_rounds, d_rounds):
    buffer = __siphash_variable_ffi.new("char[{}]".format(output_length))
...
def __compute_half_siphash(key, data, output_length, c_rounds, d_rounds):
    buffer = __halfsiphash_variable_ffi.new("char[{}]".format(output_length))
...
def siphash_64(key, data, c_rounds=2, d_rounds=4):
    ...
    if c_rounds == 2 and d_rounds == 4:
        code, buffer = __compute_siphash24(key, data, 8)
    else:
        code, buffer = __compute_siphash(key, data, 8, c_rounds, d_rounds)

    return __process_out(code, buffer)
...
def siphash_128(key, data, c_rounds=2, d_rounds=4):
    ...
    if c_rounds == 2 and d_rounds == 4:
        code, buffer = __compute_siphash24(key, data, 16)
    else:
        code, buffer = __compute_siphash(key, data, 16, c_rounds, d_rounds)
...
def half_siphash_32(key, data, c_rounds=2, d_rounds=4):
    ...
    if c_rounds == 2 and d_rounds == 4:
        code, buffer = __compute_half_siphash24(key, data, 4)
    else:
        code, buffer = __compute_half_siphash(key, data, 4, c_rounds, d_rounds)
...
def half_siphash_64(key, data, c_rounds=2, d_rounds=4):
    ...
    if c_rounds == 2 and d_rounds == 4:
        code, buffer = __compute_half_siphash24(key, data, 8)
    else:
        code, buffer = __compute_half_siphash(key, data, 8, c_rounds, d_rounds)
