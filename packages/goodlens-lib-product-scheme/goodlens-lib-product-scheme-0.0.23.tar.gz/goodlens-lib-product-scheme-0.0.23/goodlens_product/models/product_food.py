...
class ProductFood(Model):
    ...
    def __init__(self, food_type: str=None, manufacture_date: str=None, expiration_date: str=None, count_per_pack: str=None, origin_materials_full_text: str=None, origin_materials: List[FoodOriginMaterial]=None, nutrients: List[Nutrient]=None, genetic_recombination: str=None, is_infant_weight_control_food_ad_preview: bool=None, import_declaration_description: str=None, as_owner: str=None, phone_number: str=None, functional_information: str=None, intake: str=None, intake_notice: str=None, possible_side_effects: str=None, is_non_medication_indication: str=None, is_display_ad_preview: bool=None, item_manufacture_mgmt_number: str=None, allergens: List[str]=None, factory_allergens_notice: str=None, function: str=None, step_by_step: str=None, vitamin_type: str=None, min_age: int=None, pack_type: str=None, material: str=None, product_type: str=None, cooking_time: str=None, cooking_capacity: str=None, is_green_certification: bool=None, cetification: str=None, is_no_additives: str=None, is_recycle: str=None, additional_food_type: str=None, item_report_number: str=None, how_to_store: str=None, parent_product_id: str=None):  # noqa: E501
        ...
        :param origin_materials_full_text: The origin_materials_full_text of this ProductFood.  # noqa: E501
        :type origin_materials_full_text: str
        ...
        self.swagger_types = {
            ...
            'expiration_date': str,
            'count_per_pack': str,
            'origin_materials_full_text': str,
        ...
        self.attribute_map = {
            ...
            'origin_materials_full_text': 'origin_materials_full_text',
        ...
        self._origin_materials_full_text = origin_materials_full_text
    ...
    @property
    def origin_materials_full_text(self) -> str:
        """Gets the origin_materials_full_text of this ProductFood.

        원재료명함량 (Full Text)  # noqa: E501

        :return: The origin_materials_full_text of this ProductFood.
        :rtype: str
        """
        return self._origin_materials_full_text

    @origin_materials_full_text.setter
    def origin_materials_full_text(self, origin_materials_full_text: str):
        """Sets the origin_materials_full_text of this ProductFood.

        원재료명함량 (Full Text)  # noqa: E501

        :param origin_materials_full_text: The origin_materials_full_text of this ProductFood.
        :type origin_materials_full_text: str
        """
