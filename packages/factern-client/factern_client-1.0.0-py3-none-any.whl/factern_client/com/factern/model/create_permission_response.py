...
class CreatePermissionResponse(object):
    ...
    def __init__(self, timestamp=None, node_id=None, agent=None, summary=None, batch_id=None, fact_type=None, parent_id=None, permission_interface_id=None):  # noqa: E501
