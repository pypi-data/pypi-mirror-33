...
class LabelList(object):
    ...
    def __init__(self, timestamp=None, node_id=None, agent=None, batch_id=None, fact_type=None, parent_id=None, description=None, members=None, name=None):  # noqa: E501
