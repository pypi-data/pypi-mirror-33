...
class CreateLoginResponse(object):
    ...
    def __init__(self, timestamp=None, node_id=None, agent=None, summary=None, batch_id=None, fact_type=None, parent_id=None, data_root_node=None, status=None):  # noqa: E501
