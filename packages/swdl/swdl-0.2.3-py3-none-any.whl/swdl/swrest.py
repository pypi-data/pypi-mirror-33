    ...
    def upload_player_positions(self, timestamp, match):
        try:
            ...
            for i in range(players.shape[0]):
                ...
                data["playerPositions"][i]["positionX"] = int(players[i][2] / 1000)
                data["playerPositions"][i]["positionY"] = int(players[i][3] / 1000)
                data["playerPositions"][i]["certainty"] = int(players[i][4] / 1000)
