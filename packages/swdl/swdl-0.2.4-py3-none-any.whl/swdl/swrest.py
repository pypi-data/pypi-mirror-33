    ...
    def upload_player_positions(self, timestamp, match):
        try:
            ...
            for i in range(players.shape[0]):
                ...
                data["playerPositions"][i]["positionX"] = float(players[i][2] / 1000)
                data["playerPositions"][i]["positionY"] = float(players[i][3] / 1000)
                data["playerPositions"][i]["certainty"] = float(players[i][4] / 1000)
