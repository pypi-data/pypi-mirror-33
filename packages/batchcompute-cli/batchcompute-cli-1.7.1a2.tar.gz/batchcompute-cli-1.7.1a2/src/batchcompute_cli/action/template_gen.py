...
def replaceTemplate4GATK(dist):
    # main.sh
    _replace_template(os.path.join(dist, 'fastq-to-ubam', 'main.sh'))
    ...
    _replace_template(os.path.join(dist, 'gatk4-data-processing', 'src',
                                   'processing-for-variant-discovery-gatk4.hg38.wgs.inputs.30x.spot.json'))
    ...
    _replace_template(os.path.join(dist, 'gatk4-germline-snps-indels', 'src',
                                   'haplotypecaller-gvcf-gatk4.hg38.wgs.inputs.30x.spot.json'))
