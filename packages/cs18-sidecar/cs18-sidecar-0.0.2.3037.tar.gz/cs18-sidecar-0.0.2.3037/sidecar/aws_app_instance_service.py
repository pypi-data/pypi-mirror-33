...
class AwsAppInstanceService(IAppInstanceService):
    def __init__(self, sandbox_id: str, logger: Logger, aws_session: AwsSession,aws_status_maintainer: AWSStatusMaintainer):
    ...
    def _update_app_status(self, instance_id: str, app_name: str, status: str):
        ...
        instance_logical_id =AwsTagHelper.safely_get_tag(instance, Const.INSTANCELOGICALID)
        self.aws_status_maintainer.update_app_instance_status(instance_logical_id,instance_id,app_name,Const.APP_STATUS_TAG,status)
