...
class AppInstanceConfigStatusEventReporter:
    def __init__(self, app_instance_event_handler: AppInstanceEventHandler) -> None:
        super().__init__()
    ...
    def on_app_instance_configuration_status_updated(self, app_instance_identifier: AppInstanceIdentifier,
        ...
        app_instance_event = self._convert_to_app_instance_event(app_instance_config_status)
        self._app_instance_event_handler.report_event(app_instance_identifier, app_instance_event)

    @staticmethod
    def _convert_to_app_instance_event(app_instance_config_status: str) -> str:
