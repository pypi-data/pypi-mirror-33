            ...
            try:
                ...
                if pod_json:
                    ...
                    if remains == 0:
                        ...
                        self.logger.info("pod for app '{}' with address '{}' not found ({} remaining attempts)"
                                         .format(app_name, ip_address, remains))
            except Exception as e:
                if remains == 0:
                    raise e
                else:
                    self.logger.exception("error while getting pod json by ip ({REMAINS} remaining attempts)"
