...
class AwsTagHelper:
    ...
    @staticmethod
    def safely_get_tag(resource, tag_name: str, value_if_missing: str = None) -> str:
        return AwsTagHelper.get_tags(resource=resource).get(tag_name, value_if_missing)
    ...
    @staticmethod
    def get_apps_status_map(instance) -> {}:
        apps_status_tag_value = AwsTagHelper.safely_get_tag(instance, Const.APP_STATUS_TAG)
