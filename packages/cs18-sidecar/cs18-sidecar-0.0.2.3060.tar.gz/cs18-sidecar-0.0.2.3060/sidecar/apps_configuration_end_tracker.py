...
class AppsConfigurationEndTracker:
    ...
    def _invalidate_app_records(self):
        ...
        if missing_identifiers:
            ...
            self._logger.info("{count} of the configured app instances were purged from the cache: {details}"
    ...
    def _get_missing_app_instance_identifiers(self) -> List[AppInstanceIdentifier]:
        ...
        actual_app_instance_identifiers = set(self._app_instance_service.get_all_app_instances())
