...
class AppStatusMaintainer:
    ...
    def update_status(self, app_instance_identifier: AppInstanceIdentifier, status: str):
        ...
        with self._lock:
            ...
            self._logger.info("updating configuration status if not stale to '{STATUS}' for app instance '{APP_ID}'"
            ...
            self._logger.info("configuration status updated to '{STATUS}' for app instance '{APP_ID}'"
                              .format(APP_ID=app_instance_identifier, STATUS=status))
            self._logger.info("updating app instance configuration status to '{STATUS}' for app instance '{APP_ID}'"
                              .format(APP_ID=app_instance_identifier, STATUS=status))
            ...
            self._logger.info("updated app instance configuration status to '{STATUS}' for app instance '{APP_ID}'"
                              .format(APP_ID=app_instance_identifier, STATUS=status))
