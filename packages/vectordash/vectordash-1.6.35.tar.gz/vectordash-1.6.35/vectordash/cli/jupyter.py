        ...
        if os.path.isfile(token):
            ...
            if r.status_code == 200:
                ...
                if data.get(machine):
                    ...
                    cmd = 'jupyter notebook --no-browser --port=8889 --NotebookApp.token={} > /home/ubuntu/jup_out 2>&1 & disown'.format(jupyter_token)
                    print("Executing: " + cmd)
                    ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command(cmd)

                    # jupyter localhost port forwarding command
                    jupyter_command = ['ssh', '-i', key_file, '-N', '-L', 'localhost:8890:localhost:8889',
                    ...
                    try:
                        ...
                        print("When finished with your notebook, you may close the jupyter server with CTRL + C")
