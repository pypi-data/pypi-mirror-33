...
class Nud_orolt():
	def __init__(self, a, virtualC,  name, file_on = "/usr/local/lib/python3.5/dist-packages/nomunkhet_rpi/arrowU.py", file_off = "/usr/local/lib/python3.5/dist-packages/nomunkhet_rpi/arrowD.py", r = 0, c = 0, port = 0, pullup = "no"):
