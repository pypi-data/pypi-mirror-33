...
_GETSTRATEGIESREQ.fields_by_name['filter'].message_type = common__pb2._FILTER
_GETSTRATEGIESOFSTAGEREQ.fields_by_name['filter'].message_type = common__pb2._FILTER
_GETSTARTCOMMANDSREQ.fields_by_name['filter'].message_type = common__pb2._FILTER
_GETSTRATEGYSTATUSESREQ.fields_by_name['filter'].message_type = common__pb2._FILTER
_GETSTRATEGYLOGSREQ.fields_by_name['filter'].message_type = common__pb2._FILTER
...
SetAccountsReq = _reflection.GeneratedProtocolMessageType('SetAccountsReq', (_message.Message,), dict(
  ...
  __module__ = 'strategy_service_pb2'
...
_STRATEGYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=strategy__pb2._STRATEGY,
    output_type=strategy__pb2._STRATEGY,
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=strategy__pb2._STRATEGIES,
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\020*\016/v3/strategies')),
  ),
  _descriptor.MethodDescriptor(
    name='SetAccounts',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002*\032%/v3/strategies/{strategy_id}/accounts:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetAccounts',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=strategy__pb2._STRATEGYSTATUSES,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=9,
    containing_service=None,
    input_type=strategy__pb2._STOPCOMMAND,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=strategy__pb2._STARTCOMMANDS,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=11,
    containing_service=None,
    input_type=strategy__pb2._STARTCOMMAND,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
