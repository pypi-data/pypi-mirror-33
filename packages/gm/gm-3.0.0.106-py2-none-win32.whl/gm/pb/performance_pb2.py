...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x11performance.proto\x12\x0fperformance.api\x1a\raccount.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a-github.com/gogo/protobuf/gogoproto/gogo.proto\"\xda\x02\n\tIndicator\x12\x12\n\naccount_id\x18\x01 \x01(\t\x12\x11\n\tpnl_ratio\x18\x02 \x01(\x01\x12\x18\n\x10pnl_ratio_annual\x18\x03 \x01(\x01\x12\x13\n\x0bsharp_ratio\x18\x04 \x01(\x01\x12\x14\n\x0cmax_drawdown\x18\x05 \x01(\x01\x12\x12\n\nrisk_ratio\x18\x06 \x01(\x01\x12\x12\n\nopen_count\x18\x07 \x01(\x05\x12\x13\n\x0b\x63lose_count\x18\x08 \x01(\x05\x12\x11\n\twin_count\x18\t \x01(\x05\x12\x12\n\nlose_count\x18\n \x01(\x05\x12\x11\n\twin_ratio\x18\x0b \x01(\x01\x12\x34\n\ncreated_at\x18\x0c \x01(\x0b\x32\x1a.google.protobuf.TimestampB\x04\x90\xdf\x1f\x01\x12\x34\n\nupdated_at\x18\r \x01(\x0b\x32\x1a.google.protobuf.TimestampB\x04\x90\xdf\x1f\x01\"6\n\nIndicators\x12(\n\x04\x64\x61ta\x18\x01 \x03(\x0b\x32\x1a.performance.api.Indicator\"\xed\x02\n\x11IndicatorDuration\x12\x12\n\naccount_id\x18\x01 \x01(\t\x12\x11\n\tpnl_ratio\x18\x02 \x01(\x01\x12\x0b\n\x03pnl\x18\x03 \x01(\x01\x12\x0c\n\x04\x63\x61sh\x18\x04 \x01(\x01\x12\x0c\n\x04\x66pnl\x18\x05 \x01(\x01\x12\x0e\n\x06\x66rozen\x18\x06 \x01(\x01\x12%\n\tpositions\x18\x07 \x03(\x0b\x32\x12.core.api.Position\x12\x0f\n\x07\x63um_pnl\x18\x08 \x01(\x01\x12\x0f\n\x07\x63um_buy\x18\t \x01(\x01\x12\x10\n\x08\x63um_sell\x18\n \x01(\x01\x12\x31\n\x08\x64uration\x18\x0b \x01(\x0b\x32\x19.google.protobuf.DurationB\x04\x98\xdf\x1f\x01\x12\x34\n\ncreated_at\x18\x0c \x01(\x0b\x32\x1a.google.protobuf.TimestampB\x04\x90\xdf\x1f\x01\x12\x34\n\nupdated_at\x18\r \x01(\x0b\x32\x1a.google.protobuf.TimestampB\x04\x90\xdf\x1f\x01\"F\n\x12IndicatorDurations\x12\x30\n\x04\x64\x61ta\x18\x01 \x03(\x0b\x32\".performance.api.IndicatorDurationb\x06proto3')
  ,
  dependencies=[account__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,google_dot_protobuf_dot_duration__pb2.DESCRIPTOR,github_dot_com_dot_gogo_dot_protobuf_dot_gogoproto_dot_gogo__pb2.DESCRIPTOR,])
...
_INDICATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='created_at', full_name='performance.api.Indicator.created_at', index=11,
    ...
    _descriptor.FieldDescriptor(
      name='updated_at', full_name='performance.api.Indicator.updated_at', index=12,
...
_INDICATORDURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cash', full_name='performance.api.IndicatorDuration.cash', index=3,
      number=4, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='fpnl', full_name='performance.api.IndicatorDuration.fpnl', index=4,
      number=5, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='frozen', full_name='performance.api.IndicatorDuration.frozen', index=5,
      number=6, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='positions', full_name='performance.api.IndicatorDuration.positions', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cum_pnl', full_name='performance.api.IndicatorDuration.cum_pnl', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cum_buy', full_name='performance.api.IndicatorDuration.cum_buy', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cum_sell', full_name='performance.api.IndicatorDuration.cum_sell', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='duration', full_name='performance.api.IndicatorDuration.duration', index=10,
    ...
    _descriptor.FieldDescriptor(
      name='created_at', full_name='performance.api.IndicatorDuration.created_at', index=11,
      number=12, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\220\337\037\001'))),
    _descriptor.FieldDescriptor(
      name='updated_at', full_name='performance.api.IndicatorDuration.updated_at', index=12,
      number=13, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INDICATORDURATION.fields_by_name['positions'].message_type = account__pb2._POSITION
