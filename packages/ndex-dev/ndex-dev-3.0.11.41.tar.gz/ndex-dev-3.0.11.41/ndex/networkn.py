...
class NdexGraph (MultiDiGraph):
    ...
    def __init__(self, cx=None, server=None, username=None, password=None, uuid=None, networkx_G=None, data=None, user_agent='', **attr):
     ...
     #   self.node_prepresent_map ={} #stores the mapping from cx nodeId to its represents
        ...
        if not cx and server and uuid:
            ...
            ndex = nc.Ndex(server, username, password, user_agent=self.user_agent)
