...
class _Config(object):
    ...
    @property
    def sub_claim_key(self):
        return current_app.config['JWT_SUB_CLAIM']

    @property
    def iss_claim_key(self):
        return current_app.config['JWT_ISS_CLAIM']

    @property
    def aud_claim_key(self):
        return current_app.config['JWT_AUD_CLAIM']

    @property
    def claims_in_refresh_token(self):
