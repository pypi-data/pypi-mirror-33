...
class LogsApi(object):
    ...
    def log_file_handler(self, logpath, **kwargs):
        ...
        >>> thread = api.log_file_handler(logpath, async_param=True)
        >>> result = thread.get()
    ...
    def log_file_handler_with_http_info(self, logpath, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_param=True
        >>> thread = api.log_file_handler_with_http_info(logpath, async_param=True)
        >>> result = thread.get()
    ...
    def log_file_list_handler(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_param=True
        >>> thread = api.log_file_list_handler(async_param=True)
        >>> result = thread.get()
    ...
    def log_file_list_handler_with_http_info(self, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_param=True
        >>> thread = api.log_file_list_handler_with_http_info(async_param=True)
        >>> result = thread.get()
