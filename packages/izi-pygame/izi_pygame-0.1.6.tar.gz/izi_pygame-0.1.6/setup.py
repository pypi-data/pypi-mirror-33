...
setuptools.setup(
    ...
    + " In the 0.1.6 version(bug fix about doc), call izi_pygame.doc() the github of the project will open. dowload project and open /doc/index.html with your browser"
