...
class Simulation(object):
    ...
    def simulate(self):
        ...
        while self.run_time <= self.params.duration:
            ...
            print 'Simulation step took {t.red}{0:.9g}s{t.normal}.'.format(end-start,t=term)
            ...
            #if self.run_time > 250:
            #    self.params.wipe_population = None
            ...
            self.system.environment.grid_toggle_update(True)
            ...
            # update the phylegenetic tree of the population
            # adds new leafs on the tree
            # prunes extinct lineages
    ...
    def simulation_step(self, global_time=None, diffusion_steps=None,
        ...
        * save variables states back to python objects (if no errors occured or > maxtries)
        ...
        while (errors or start):
            if release_delay:
                print 'Release delay: Waiting', release_delay, 'more steps to lower diffusion steps.'
            # if necessary grow the arrays to hold the time course data
            self.system.population.grow_time_course_arrays()

            product_scaling = self.system.population.historic_production_max
            print 'Production scaling:', product_scaling
            print 'Updating spatial integrator.'
