...
class Event(object):
    ...
    def __repr__(self):
        """
        The function to returns the actor name an the event type.

        :return: The name of the actor and the type of event.
        """
        return "-- {} {}".format(
            self._actor.name, str(type(self))).strip()
    ...
    def invoke(self, *args) -> object:
        ...
        :return: The result of the callable function.
        """
        params = self._resolve(self._actor, list(args), self.__class__)
