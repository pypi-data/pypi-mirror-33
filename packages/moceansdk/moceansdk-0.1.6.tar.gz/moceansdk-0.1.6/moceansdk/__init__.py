...
class Mocean(object):
    ...
    @property
    def sms(self):
        from modules.Message.sms import SMS
...
#         return Hlr_query(self.obj_auth)
    ...
    @property
    def balance(self):
        from modules.Account.balance import Balance
        return Balance(self.obj_auth)
    
    @property
    def price_list(self):
        from modules.Account.pricing import Pricing
        return Pricing(self.obj_auth)
    
    @property
    def message_status(self):
        from modules.Message.message_status import Messsage_status
        return Messsage_status(self.obj_auth)
    
    @property
    def verify_request(self):
        from modules.Message.verify_request import Verify_request
        return Verify_request(self.obj_auth)

    @property
    def verify_validate(self):
        from modules.Message.verify_validate import Verify_validate
