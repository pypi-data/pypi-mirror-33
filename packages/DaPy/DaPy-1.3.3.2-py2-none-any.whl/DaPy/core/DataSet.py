...
from base import is_value, is_iter, SeriesSet, Frame, Matrix, parse_addr
...
class DataSet(object):
    ...
    ==============================================
    '''
    __all__ = ['data', 'titles', 'sheets','info', 'dim', 'append', 'append_col',
    ...
    def __getitem__(self, pos):
        if len(self._data) == 1 and (pos not in self._sheets):
            ...
            if is_value(return_data):
                return return_data
            return DataSet(self._data[0][pos],
                           self._sheets[0])
