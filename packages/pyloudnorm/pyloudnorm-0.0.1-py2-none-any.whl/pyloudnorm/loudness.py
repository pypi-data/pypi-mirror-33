...
class Meter():
    ...
    # this may become general loudness function with paramters for block size
    # what do momentary, integrated, and short-term mean in context of custom block sizes?
    # feels like those methods would have constant block sizes (by standard)
    def integrated(self, data, channels=1, verbose=False):
