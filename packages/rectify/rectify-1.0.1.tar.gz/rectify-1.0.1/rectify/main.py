...
Options:
  ...
  -r PALETTE, --bars PALETTE        Palette to take the bar colors from.
  -c COUNT, --count COUNT           Approximate amount of bars to generate.
