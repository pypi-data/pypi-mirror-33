...
def add_clickjacking(request, response):
...
class GlobalRequestMiddleware(object):
    ...
    def process_response(self, request, response):
        ...
        safe_wrap_function("Insert CSP Headers", add_csp, request, response)
        safe_wrap_function("Insert Clickjacking Headers", add_clickjacking, request, response)
        safe_wrap_function("Insert Secure Headers", add_secure_headers, response)
