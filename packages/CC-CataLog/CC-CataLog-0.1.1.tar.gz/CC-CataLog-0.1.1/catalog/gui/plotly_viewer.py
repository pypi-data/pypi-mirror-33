...
path_to_plotly_js = os.environ['CATALOGPATH']+'/gui/plotly-latest.min.js'
...
class PlotlyView(QtWidgets.QWidget):
    def __init__(self
        ...
        self.local             = QtCore.QUrl.fromLocalFile(path_to_plotly_js).toString()
    ...
    def _build_html(self) -> None:
        ...
        raw_html   += '<script src="{}"></script></head>'.format(self.local)
        raw_html   += '<body>'
