...
def log(params):
    import catalog.datalog.datalog as datalog
    import json
...
def executeAndCollect():
    ...
    try:
        ...
        error_file = glob.glob('*.error')[0]
        with open(error_file,'r') as f:
            traceback = f.read()
        return fireworks.core.firework.FWAction(stored_data={'_exception':{'_traceback':traceback}})
