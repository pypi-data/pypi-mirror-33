...
def scatter(sim, method='lu', 
              ...
              multithreaded=True, Nprocesses=None, verbose=True):
...
def scatter_mpi(sim, verbose=False, multithreaded=False, **kwargs):
...
#            _sim.efield.wavelengths = [wl]
    ...
    for job in jobs:
        ...
        scattered_field = scatter(job, multithreaded=multithreaded, **kwargs)
