    ...
    def analyze(self, use_cache = True):
        ...
        if self._has_valid_cache() and use_cache:
            ...
            with open(self._file_path, 'rb') as f:
                ...
                if len(self._src_lang) < self._languages_detection_batch_size \
                    and len(self._src_lang)<0.8*(num_line + 1):
                    raise ValueError('Incorrect language for ' + self._file_basename)
