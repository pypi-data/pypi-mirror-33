...
d = pyspedas.load_data('themis', '2015-12-25', ['tha'], 'sst', 'l2', False)
pytplot.tplot_options('title', 'tha_psif_en_eflux 2015-12-25') 
pytplot.ylim('tha_psif_en_eflux', 10000.0, 10000000.0)
pytplot.options('tha_psif_en_eflux', 'colormap', 'viridis')
pytplot.tplot(['tha_psif_en_eflux'], bokeh=True)
