...
Example:
    pyspedas.themis_load_gmag(['2015-12-31'], ['bmls', 'ccnv', 'drby'])
...
def themis_load_gmag(dates, stations, downloadonly=False, varformat=None, get_support_data=False, prefix='', suffix=''):
