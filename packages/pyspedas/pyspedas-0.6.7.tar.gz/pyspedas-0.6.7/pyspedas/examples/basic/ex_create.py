...
def ex_create():
    ...
    #Interpolate
    pyspedas.tinterpol(['sinx-clip-deflag'],['sinx'])
    #Plot
    pytplot.ylim('sinx', -1100.0, 1100.0)
    pytplot.ylim('sinx-clip', -1100.0, 1100.0)
    pytplot.ylim('sinx-clip-deflag', -1100.0, 1100.0)
    pytplot.ylim('sinx-clip-deflag-tinterp', -1100.0, 1100.0)
    pytplot.tplot(['sinx','sinx-clip', 'sinx-clip-deflag', 'sinx-clip-deflag-tinterp'])
