...
Desrciption:  
    Main load function for pyspedas. 
    Downloads mission-specific cdf files and loads data into pytplot. 
...
def load_data(mission, dates, probes, instruments, level, other=None, downloadonly=False, varformat=None, get_support_data=False, prefix='', suffix=''):
    ...
    if mission == 'themis':
        ...
        gmag_load(dates, stations, group=other, downloadonly, varformat, get_support_data, prefix, suffix)
    elif mission == 'omni':
