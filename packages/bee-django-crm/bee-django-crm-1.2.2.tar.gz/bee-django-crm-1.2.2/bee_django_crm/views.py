...
class PreuserList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['search_form'] = PreuserSearchForm(
            {"level": level, "name": name, "mobile": mobile, "source_name": source_name, "referral_name1": referral_name1,
...
def update_preuser(request, pk):
    ...
    if request.POST:
        ...
        if form.is_valid():
            ...
            referral_user1 = get_object_or_404(User,pk=referral_user_id1)
            print('==',referral_user1)
            try:
