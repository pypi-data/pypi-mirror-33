...
logging_level_name_map = dict(TRACE=logging.DEBUG, DEBUG=logging.DEBUG, INFO=logging.INFO, WARNNING=logging.WARN, ERROR=logging.ERROR, FATAL=logging.CRITICAL)
