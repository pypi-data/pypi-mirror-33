...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeImportedContact, TypePeer, TypeChat, TypeTopPeerCategoryPeers, TypeContact, TypeContactLink, TypePopularContact, TypeContactBlocked
