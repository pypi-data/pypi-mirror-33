...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeDialog, TypeEncryptedFile, TypeMessage, TypeStickerSetCovered, TypeChat, TypeStickerSet, TypeDocument, TypeHighScore, TypeStickerPack, TypeFoundGif, TypeBotInlineResult, TypeChatFull, TypeInlineBotSwitchPM
