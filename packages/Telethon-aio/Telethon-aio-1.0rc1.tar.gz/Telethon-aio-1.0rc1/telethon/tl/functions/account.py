...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeSecureValueType, TypeInputPeer, TypeInputSecureValue, TypeInputPeerNotifySettings, TypeSecureValueHash, TypeInputPrivacyKey, TypeReportReason, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeBool
