...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeBool, TypeChannelBannedRights, TypeInputUser, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeInputChatPhoto, TypeInputStickerSet, TypeChannelParticipantsFilter, TypeInputChannel
