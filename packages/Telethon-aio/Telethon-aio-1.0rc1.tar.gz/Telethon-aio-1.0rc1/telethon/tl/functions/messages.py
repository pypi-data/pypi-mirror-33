...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeShippingOption, TypeInputBotInlineResult, TypeMessagesFilter, TypeReportReason, TypeInputEncryptedChat, TypeInputBotInlineMessageID, TypeBool, TypeSendMessageAction, TypeInputChatPhoto, TypeInputDocument, TypeMessageEntity, TypeInputEncryptedFile, TypeInputDialogPeer, TypeInputMedia, TypeInputGeoPoint, TypeInputSingleMedia, TypeInputUser, TypeInputMessage, TypeReplyMarkup, TypeInputStickeredMedia, TypeInputStickerSet, TypeInlineBotSwitchPM
