...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeTopPeerCategoryPeers, TypeContactBlocked, TypeChat, TypePeer, TypeImportedContact, TypePopularContact, TypeContact, TypeUser
