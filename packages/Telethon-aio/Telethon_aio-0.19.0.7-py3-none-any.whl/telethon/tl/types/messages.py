...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessage, TypeDocument, TypeStickerSetCovered, TypeFoundGif, TypeEncryptedFile, TypeChat, TypeBotInlineResult, TypeHighScore, TypeStickerPack, TypeStickerSet, TypeChatFull, TypeDialog, TypeInlineBotSwitchPM, TypeUser
