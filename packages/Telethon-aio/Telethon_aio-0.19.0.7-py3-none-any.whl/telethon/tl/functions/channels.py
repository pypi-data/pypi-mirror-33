...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelBannedRights, TypeInputStickerSet, TypeInputChannel, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeInputUser, TypeChannelAdminRights, TypeInputMessage, TypeBool, TypeChannelParticipantsFilter
