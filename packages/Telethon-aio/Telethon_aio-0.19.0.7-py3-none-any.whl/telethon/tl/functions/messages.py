...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeShippingOption, TypeInputChatPhoto, TypeInputSingleMedia, TypeBool, TypeInputStickeredMedia, TypeReplyMarkup, TypeInputMedia, TypeInputStickerSet, TypeInputBotInlineResult, TypeInputEncryptedChat, TypeInputGeoPoint, TypeInlineBotSwitchPM, TypeInputUser, TypeInputPeer, TypeInputEncryptedFile, TypeInputDialogPeer, TypeInputMessage, TypeInputDocument, TypeMessagesFilter, TypeMessageEntity, TypeSendMessageAction, TypeReportReason, TypeInputBotInlineMessageID
