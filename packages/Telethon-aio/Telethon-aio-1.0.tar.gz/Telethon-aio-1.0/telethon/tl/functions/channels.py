...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeChannelAdminRights, TypeInputStickerSet, TypeInputUser, TypeInputMessage, TypeChannelParticipantsFilter, TypeBool, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputChatPhoto
