...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyRule, TypeSecureValueHash, TypeInputPrivacyKey, TypeAccountDaysTTL, TypeInputSecureValue, TypeBool, TypeInputPeer, TypeSecureValueType, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeReportReason, TypeSecureCredentialsEncrypted
