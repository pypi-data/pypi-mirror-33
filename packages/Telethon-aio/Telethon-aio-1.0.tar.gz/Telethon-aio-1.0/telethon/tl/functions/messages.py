...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSendMessageAction, TypeInputStickerSet, TypeInputUser, TypeReplyMarkup, TypeInputBotInlineMessageID, TypeInputDialogPeer, TypeReportReason, TypeInputMessage, TypeInputEncryptedChat, TypeInputPeer, TypeInputStickeredMedia, TypeInputChatPhoto, TypeInputGeoPoint, TypeInputEncryptedFile, TypeBool, TypeInputSingleMedia, TypeInputDocument, TypeInputMedia, TypeMessagesFilter, TypeInlineBotSwitchPM, TypeInputBotInlineResult, TypeMessageEntity, TypeShippingOption
