...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeTopPeerCategoryPeers, TypeContact, TypeContactBlocked, TypeImportedContact, TypeChat, TypeContactLink, TypeUser, TypePeer, TypePopularContact
