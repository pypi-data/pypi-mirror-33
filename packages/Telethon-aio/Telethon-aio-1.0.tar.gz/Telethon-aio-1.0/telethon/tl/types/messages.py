...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerPack, TypeFoundGif, TypeDocument, TypeUser, TypeEncryptedFile, TypeStickerSet, TypeChatFull, TypeHighScore, TypeInlineBotSwitchPM, TypeStickerSetCovered, TypeChat, TypeDialog, TypeMessage, TypeBotInlineResult
