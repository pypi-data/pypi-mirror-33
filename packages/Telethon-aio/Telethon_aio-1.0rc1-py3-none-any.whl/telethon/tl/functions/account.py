...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeBool, TypeSecureValueType, TypeInputPeer, TypeInputSecureValue, TypeSecureValueHash, TypeSecureCredentialsEncrypted, TypeInputPeerNotifySettings, TypeInputPrivacyKey
