...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeInputMessage, TypeInputChatPhoto, TypeInputDocument, TypeReplyMarkup, TypeBool, TypeInputEncryptedChat, TypeSendMessageAction, TypeMessageEntity, TypeInputPeer, TypeInputGeoPoint, TypeInputStickerSet, TypeInputUser, TypeInputSingleMedia, TypeShippingOption, TypeReportReason, TypeInputBotInlineResult, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeInputMedia, TypeMessagesFilter, TypeInputDialogPeer, TypeInputStickeredMedia
