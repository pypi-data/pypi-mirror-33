...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelBannedRights, TypeChannelAdminRights, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeInputStickerSet, TypeBool, TypeInputChannel, TypeInputUser
