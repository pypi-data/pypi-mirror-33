...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeContactBlocked, TypeTopPeerCategoryPeers, TypeUser, TypePopularContact, TypeChat, TypePeer, TypeImportedContact, TypeContactLink
