...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeHighScore, TypeFoundGif, TypeInlineBotSwitchPM, TypeDialog, TypeMessage, TypeStickerSetCovered, TypeUser, TypeChatFull, TypeStickerSet, TypeChat, TypeEncryptedFile, TypeDocument, TypeStickerPack, TypeBotInlineResult
