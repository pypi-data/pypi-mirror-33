...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeDocument, TypeMessage, TypeFoundGif, TypeEncryptedFile, TypeInlineBotSwitchPM, TypeHighScore, TypeStickerSet, TypeDialog, TypeBotInlineResult, TypeUser, TypeStickerPack, TypeStickerSetCovered, TypeChatFull
