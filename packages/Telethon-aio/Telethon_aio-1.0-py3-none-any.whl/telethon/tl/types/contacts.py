...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeContact, TypeImportedContact, TypePeer, TypeTopPeerCategoryPeers, TypeUser, TypeContactLink, TypePopularContact, TypeContactBlocked
