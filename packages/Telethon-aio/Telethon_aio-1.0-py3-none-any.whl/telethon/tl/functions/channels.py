...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeChannelParticipantsFilter, TypeBool, TypeChannelAdminRights, TypeInputChannel, TypeInputMessage, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputChatPhoto, TypeInputUser
