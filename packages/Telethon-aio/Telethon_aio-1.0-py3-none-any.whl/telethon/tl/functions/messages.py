...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeInputStickeredMedia, TypeInputDialogPeer, TypeInputChatPhoto, TypeInputStickerSet, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeShippingOption, TypeInputMessage, TypeInlineBotSwitchPM, TypeMessagesFilter, TypeSendMessageAction, TypeInputMedia, TypeInputUser, TypeInputBotInlineResult, TypeInputSingleMedia, TypeInputGeoPoint, TypeBool, TypeReplyMarkup, TypeMessageEntity, TypeInputPeer, TypeReportReason, TypeInputDocument
