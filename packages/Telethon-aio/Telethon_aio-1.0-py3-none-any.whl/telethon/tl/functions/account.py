...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeInputPeerNotifySettings, TypeBool, TypeSecureValueHash, TypeSecureValueType, TypeInputPeer, TypeReportReason, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeInputSecureValue, TypeInputPrivacyRule, TypeInputNotifyPeer
