...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeUser, TypeChat, TypeContactLink, TypeImportedContact, TypeTopPeerCategoryPeers, TypePeer, TypePopularContact, TypeContactBlocked
