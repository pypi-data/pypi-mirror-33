...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessage, TypeUser, TypeChat, TypeStickerSet, TypeInlineBotSwitchPM, TypeStickerPack, TypeBotInlineResult, TypeFoundGif, TypeHighScore, TypeDocument, TypeChatFull, TypeDialog, TypeEncryptedFile, TypeStickerSetCovered
