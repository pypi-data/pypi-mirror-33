...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeInputUser, TypeBool, TypeInputChannel, TypeInputMessage, TypeChannelAdminRights, TypeInputStickerSet, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputChatPhoto
