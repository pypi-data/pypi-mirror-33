...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeInputPrivacyKey, TypeAccountDaysTTL, TypeBool, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeReportReason, TypeInputPeerNotifySettings
