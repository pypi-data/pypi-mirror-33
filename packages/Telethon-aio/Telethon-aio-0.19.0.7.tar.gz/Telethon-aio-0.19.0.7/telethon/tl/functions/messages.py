...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeInputMessage, TypeReplyMarkup, TypeInputUser, TypeInputEncryptedFile, TypeInputDialogPeer, TypeBool, TypeInputBotInlineResult, TypeMessagesFilter, TypeMessageEntity, TypeInputEncryptedChat, TypeInputStickerSet, TypeInputGeoPoint, TypeInputPeer, TypeInputBotInlineMessageID, TypeInputStickeredMedia, TypeInputSingleMedia, TypeShippingOption, TypeSendMessageAction, TypeInputDocument, TypeInputMedia, TypeReportReason, TypeInputChatPhoto
