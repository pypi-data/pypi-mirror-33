...
def get_time_steps(
    ...
    if not (
        ...
        raise Exception(
            ...
            "a tuple of two datetime objectss or one datetime object."
        )

    if isinstance(time_range, datetime):
        return pd.date_range(time_range, time_range, freq="15T")
    elif isinstance(time_range, tuple):
        return pd.date_range(time_range[0], time_range[1], freq="15T")
