...
from anji_orm import Model, StringField, orm_register
...
class T1(Model):
    ...
    t1 = StringField()  # pylint: disable=invalid-name
...
class SyncExecutorTestCase(BaseTestCase):
    ...
    def test_executor_get(self, query_result, result_object):
...
class AsyncExecutorTestCase(asynctest.TestCase):
    ...
    async def test_executor_get(self, query_result, result_object):
