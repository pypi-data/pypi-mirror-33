...
class FlavorApkProducer(object):
    ...
    def useCustomOutputBaseDir(self, customOutputBaseDir):
        self.customOutputBaseDir = customOutputBaseDir
    ...
    def prepare(self):
        ...
        if self.customOutputBaseDir:
            self.baseDir = self.customOutputBaseDir + "/" + self.baseDir
