/*! For license information please see d1dee3fcdbe3b9a9d20d.chunk.js.LICENSE */
...
`}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_services:Array,value:{type:String,notify:!0}}}_hassChanged(e,t){if(!e)return void(this._services=[]);if(t&&e.config.services===t.config.services)return;const i=[];Object.keys(e.config.services).sort().forEach(t=>{const a=Object.keys(e.config.services[t]).sort();for(let e=0;e<a.length;e++)i.push(`${t}.${a[e]}`)}),this._services=i}})},594:function(e,t,i){"use strict";i.r(t),i(143),i(142),i(121),i(67),i(180);var a=i(0),o=i(3);i(190),i(122),i(249),i(141),i(248);const r={};customElements.define("ha-panel-dev-service",class extends o.a{static get template(){return a["a"]`
...
//# sourceMappingURL=d1dee3fcdbe3b9a9d20d.chunk.js.map