...
`}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){return 1+(this._config?this._config.entities.length:0)}_showHeaderToggle(e){return!1!==e}_showHeader(e){return e.title||e.show_header_toggle}setConfig(e){if(!function(e,t=[]){const s=e&&e.entities;return!(!s||!Array.isArray(s))&&s.every(e=>"string"==typeof e?p(e)&&!t.length:e&&"object"==typeof e&&!Array.isArray(e)&&"entity"in e&&p(e.entity)&&t.every(t=>t in e))}(e))throw Error("Error in card config.");this._config=e,this.$&&this._buildConfig()}_buildConfig(){const e=this._config,t=this.$.states,s=f(e);for(;t.lastChild;)t.removeChild(t.lastChild);this._elements=[];for(let e=0;e<s.length;e++){const i=s[e],a=i.entity;if(!(a in this.hass.states))continue;const r=this.hass.states[a],n=r?`state-card-${Object(g.a)(this.hass,r)}`:"state-card-display",o=document.createElement(n);m.c.includes(Object(d.a)(a))||(o.classList.add("state-card-dialog"),o.addEventListener("click",()=>this.fire("hass-more-info",{entityId:a}))),o.stateObj=r,o.hass=this.hass,i.name&&(o.overrideName=i.name),this._elements.push({entityId:a,element:o});const c=document.createElement("div");c.appendChild(o),t.appendChild(c)}}_hassChanged(e){for(let t=0;t<this._elements.length;t++){const{entityId:s,element:i}=this._elements[t],a=e.states[s];i.stateObj=a,i.hass=e}}});var b=s(15);customElements.define("hui-entity-filter-card",class extends a.a{static get properties(){return{hass:{type:Object,observer:"_hassChanged"}}}getCardSize(){return this.lastChild?this.lastChild.getCardSize():1}_getEntities(e,t){const s=new Set;return t.forEach(t=>{const i=[];t.domain&&i.push(e=>Object(b.a)(e)===t.domain),t.entity_id&&i.push(e=>this._filterEntityId(e,t.entity_id)),t.state&&i.push(e=>e.state===t.state),Object.values(e.states).forEach(e=>{i.every(t=>t(e))&&s.add(e.entity_id)})}),Array.from(s)}_filterEntityId(e,t){if(-1===t.indexOf("*"))return e.entity_id===t;const s=new RegExp(`^${t.replace(/\*/g,".*")}$`);return 0===e.entity_id.search(s)}setConfig(e){if(!e.filter||!Array.isArray(e.filter))throw new Error("Incorrect filter config.");this._config=e,this.lastChild&&this.removeChild(this.lastChild);const t="card"in e?Object.assign({},e.card):{};t.type||(t.type="entities"),t.entities=[];const s=$(t);s._filterRawConfig=t,this._updateCardConfig(s),s.hass=this.hass,this.appendChild(s)}_hassChanged(e){const t=this.lastChild;this._updateCardConfig(t),t.hass=e}_updateCardConfig(e){if(!e||"HUI-ERROR-CARD"===e.tagName||!this.hass)return;const t=this._getEntities(this.hass,this._config.filter);0===t.length?this.style.display=!1===this._config.show_empty?"none":"block":this.style.display="block",e.setConfig(Object.assign({},e._filterRawConfig,{entities:t}))}}),customElements.define("hui-error-card",class extends a.a{static get template(){return i["a"]`
    ...
    `}static get properties(){return{hass:Object,_config:Object,stateHistory:Object,stateHistoryLoading:Boolean}}getCardSize(){return 4}setConfig(e){if(!e.entities||!Array.isArray(e.entities))throw new Error("Error in card configuration.");this._config=e}_computeCacheConfig(e){return{cacheKey:e.entities,hoursToShow:e.hours_to_show||24,refresh:e.refresh_interval||0}}}),customElements.define("hui-horizontal-stack-card",class extends a.a{static get template(){return i["a"]`
      ...
      <div id="root"></div>
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"}}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){let e=1;return this._elements.forEach(t=>{const s=C(t);s>e&&(e=s)}),e}setConfig(e){if(!e||!e.cards||!Array.isArray(e.cards))throw new Error("Card config incorrect.");this._config=e,this.$&&this._buildConfig()}_buildConfig(){const e=this._config;this._elements=[];const t=this.$.root;for(;t.lastChild;)t.removeChild(t.lastChild);const s=[];e.cards.forEach(e=>{const i=$(e);i.hass=this.hass,s.push(i),t.appendChild(i)}),this._elements=s}_hassChanged(e){this._elements.forEach(t=>{t.hass=e})}}),customElements.define("hui-iframe-card",class extends a.a{static get template(){return i["a"]`
      <style>
        ha-card {
          line-height: 0;
          overflow: hidden;
    ...
    `}static get properties(){return{_config:Object,noTitle:{type:Boolean,reflectToAttribute:!0,computed:"_computeNoTitle(_config.title)"}}}setConfig(e){this._config=e}getCardSize(){return this._config.content.split("\n").length}_computeNoTitle(e){return!e}}),s(165),customElements.define("hui-media-control-card",class extends u{constructor(){super("ha-media_player-card","media_player")}}),s(199),s(170);const E=new Set(["service-button","state-badge","state-icon","state-label"]);customElements.define("hui-picture-elements-card",class extends(Object(r.a)(Object(w.a)(a.a))){static get template(){return i["a"]`
    <style>
      ha-card {
        overflow: hidden;
      }
...
`}static get properties(){return{hass:Object,state:{type:Object,value:null,observer:"_stateChanged"},image:String,stateImage:Object,cameraImage:String,_error:{type:Boolean,value:!1},_imageClass:String,_imageSrc:String}}static get observers(){return["_configChanged(image, stateImage, cameraImage)"]}connectedCallback(){super.connectedCallback(),this.cameraImage&&(this.timer=setInterval(()=>this._updateCameraImageSrc(),1e4))}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.timer)}_configChanged(e,t,s){s?this._updateCameraImageSrc():e&&!t&&(this._imageSrc=e)}_onImageError(){this.setProperties({_imageSrc:null,_error:!0})}_onImageLoad(){this._error=!1}_stateChanged(e){if(this.cameraImage)return;const t=!function(e,t=[]){return e&&"object"==typeof e&&!Array.isArray(e)&&t.every(t=>t in e)}(e,["state"]);if(!this.stateImage)return void(this._imageClass=t||m.g.includes(e.state)?"state-off":"");const s=t?this.stateImage.unavailable:this.stateImage[e.state]||this.stateImage.default;this.setProperties({_imageClass:s||!t&&!m.g.includes(e.state)?"":"state-off",_imageSrc:s||this.image})}_updateCameraImageSrc(){this.hass.connection.sendMessagePromise({type:"camera_thumbnail",entity_id:this.cameraImage}).then(e=>{e.success?this.setProperties({_imageSrc:`data:${e.result.content_type};base64, ${e.result.content}`,_error:!1}):this.setProperties({_imageSrc:null,_error:!0})})}});customElements.define("hui-picture-entity-card",class extends(Object(w.a)(a.a)){static get template(){return i["a"]`
    ...
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object}}getCardSize(){return 3}setConfig(e){if(!e||!e.entity||!e.image&&!e.state_image)throw new Error("Error in card configuration.");this._config=e}_hassChanged(e){const t=this._config,s=t&&t.entity;s&&(s in e.states||"Unavailable"!==this._oldState)&&(s in e.states&&e.states[s].state===this._oldState||this._updateState(e,s,t))}_updateState(e,t,s){const i=t in e.states?e.states[t].state:"Unavailable";this.$.title.innerText=s.title||("Unavailable"===i?t:Object(v.a)(e.states[t])),this.$.state.innerText="Unavailable"===i?"Unavailable":this._computeState(e.states[t]),this._oldState=i}_computeState(e){switch(Object(b.a)(e)){case"scene":return this.localize("ui.card.scene.activate");case"script":return this.localize("ui.card.script.execute");case"weblink":return"Open";default:return Object(y.a)(this.localize,e)}}_cardClicked(){const e=this._config&&this._config.entity;e in this.hass.states&&("weblink"===Object(d.a)(e)?window.open(this.hass.states[e].state):x(this.hass,e))}_getStateObj(){return this.hass&&this.hass.states[this._config.entity]}});var j=s(98);customElements.define("hui-picture-glance-card",class extends(Object(w.a)(Object(r.a)(a.a))){static get template(){return i["a"]`
      <style>
        ha-card {
          position: relative;
          min-height: 48px;
    ...
    `}static get properties(){return{hass:Object,_config:Object,_entitiesDialog:{type:Array,computed:"_computeEntitiesDialog(hass, _config, _entitiesService)"},_entitiesService:{type:Array,value:[],computed:"_computeEntitiesService(hass, _config)"}}}getCardSize(){return 3}setConfig(e){if(!e||!e.entities||!Array.isArray(e.entities)||!e.image&&!e.camera_image)throw new Error("Invalid card configuration");this._config=e}_computeEntitiesDialog(e,t,s){return t.force_dialog?t.entities:t.entities.filter(e=>!s.includes(e))}_computeEntitiesService(e,t){return t.force_dialog?[]:t.entities.filter(e=>Object(_.a)(this.hass,this.hass.states[e]))}_showEntity(e,t){return e in t}_computeIcon(e,t){return Object(j.a)(t[e])}_computeClass(e,t){return m.g.includes(t[e].state)?"":"state-on"}_computeTooltip(e,t){return`${Object(v.a)(t[e])}: ${Object(y.a)(this.localize,t[e])}`}_openDialog(e){this.fire("hass-more-info",{entityId:e.model.item})}_callService(e){const t=e.model.item;x(this.hass,t)}}),s(164),customElements.define("hui-plant-status-card",class extends u{constructor(){super("ha-plant-card","plant")}}),customElements.define("hui-vertical-stack-card",class extends a.a{static get template(){return i["a"]`
      <style>
        #root {
          display: flex;
          flex-direction: column;
      ...
      <div id="root"></div>
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"}}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){let e=0;return this._elements.forEach(t=>{e+=C(t)}),e}setConfig(e){if(!e||!e.cards||!Array.isArray(e.cards))throw new Error("Card config incorrect");this._config=e,this.$&&this._buildConfig()}_buildConfig(){const e=this._config;this._elements=[];const t=this.$.root;for(;t.lastChild;)t.removeChild(t.lastChild);const s=[];e.cards.forEach(e=>{const i=$(e);i.hass=this.hass,s.push(i),t.appendChild(i)}),this._elements=s}_hassChanged(e){this._elements.forEach(t=>{t.hass=e})}}),customElements.define("hui-weather-forecast-card",class extends u{constructor(){super("ha-weather-card","weather")}getCardSize(){return 4}});const k=["camera-preview","entities","entity-filter","error","glance","history-graph","horizontal-stack","iframe","markdown","media-control","picture-elements","picture-entity","picture-glance","plant-status","vertical-stack","weather-forecast"],O="custom:";function S(e,t){const s=document.createElement(e);try{s.setConfig(t)}catch(s){return console.error(e,s),I(s.message,t)}return s}function I(e,t){return S("hui-error-card",h(e,t))}function $(e){let t;if(!e||"object"!=typeof e||!e.type)return I("No card type configured.",e);if(e.type.startsWith(O)){if(t=e.type.substr(O.length),customElements.get(t))return S(t,e);const s=I(`Custom element doesn't exist: ${t}.`,e);return customElements.whenDefined(t).then(()=>Object(l.a)(s,"rebuild-view")),s}return k.includes(e.type)?S(`hui-${e.type}-card`,e):I(`Unknown card type encountered: ${e.type}.`,e)}customElements.define("hui-view",class extends a.a{static get template(){return i["a"]`
      <style>
      :host {
        display: block;
        padding: 4px 4px 0;
    ...
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},columns:{type:Number},config:{type:Object}}}static get observers(){return["_configChanged(columns, config)"]}constructor(){super(),this._elements=[],this._debouncedConfigChanged=function(e,t,s){let i;return function(...t){const s=this;clearTimeout(i),i=setTimeout(()=>{i=null,e.apply(s,t)},100)}}(this._configChanged)}_configChanged(){const e=this.$.columns,t=this.config;for(;e.lastChild;)e.removeChild(e.lastChild);if(!t)return void(this._elements=[]);const s=t.cards.map(e=>{const t=$(e);return t.hass=this.hass,t});let i=[];const a=[];for(let e=0;e<this.columns;e++)i.push([]),a.push(0);s.forEach(e=>{this.appendChild(e);const t="function"==typeof e.getCardSize?e.getCardSize():1;i[function(e){let t=0;for(let e=0;e<a.length;e++){if(a[e]<5){t=e;break}a[e]<a[t]&&(t=e)}return a[t]+=e,t}(t)].push(e)}),(i=i.filter(e=>e.length>0)).forEach(t=>{const s=document.createElement("div");s.classList.add("column"),t.forEach(e=>s.appendChild(e)),e.appendChild(s)}),this._elements=s,"theme"in t&&Object(c.a)(e,this.hass.themes,t.theme)}_hassChanged(e){for(let t=0;t<this._elements.length;t++)this._elements[t].hass=e}});const T={};customElements.define("hui-root",class extends(Object(n.a)(Object(r.a)(a.a))){static get template(){return i["a"]`
...
//# sourceMappingURL=d5ba691b0f22c35d0c8a.chunk.js.map