...
from _oldfast import readDRSpec
from _oldfast import syncError as gsyncError
from _oldfast import eofError as geofError
from lsl.reader.errors import *

__version__ = '0.1'
__revision__ = '$Rev: 2398 $'
__all__ = ['FrameHeader', 'FrameData', 'Frame', 'readFrame', 
           'getSampleRate', 'getFrameSize', 'getFFTsPerIntegration', 
