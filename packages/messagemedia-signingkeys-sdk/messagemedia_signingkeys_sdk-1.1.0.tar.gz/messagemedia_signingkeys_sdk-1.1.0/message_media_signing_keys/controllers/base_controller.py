...
"""
    message_media_signing_keyscontrollers.base_controller
...
from ..exceptions.create_signature_key_403_response_exception import CreateSignatureKey403ResponseException
...
class BaseController(object):
    ...
    def validate_response(self, context):
        ...
        if context.response.status_code == 403:
            raise CreateSignatureKey403ResponseException('Unexpected error in API call. See HTTP response body for details.', context)
