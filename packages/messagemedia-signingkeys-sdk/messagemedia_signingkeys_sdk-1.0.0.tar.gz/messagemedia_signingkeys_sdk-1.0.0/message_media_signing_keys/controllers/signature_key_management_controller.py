...
class SignatureKeyManagementController(BaseController):
    ...
    def delete_disable_the_current_enabled_signature_key(self,
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_disable_the_current_enabled_signature_key.')
            _headers = {
    ...
    def delete_signature_key(self,
        ...
        *Note: If an invalid or non-existent key_id parameter is specified in
        ...
        try:
            ...
            # Prepare headers
            self.logger.info('Preparing headers for delete_signature_key.')
            _headers = {
                'Content-Type': content_type,
                'Accept': accept
            }
    ...
    def get_signature_key_list(self,
                               ...
                               page=None,
                               page_size=None):
        """Does a GET request to /v1/iam/signature_keys?page={page}&page_size={page_size}.
        ...
        Args:
            content_type (string): TODO: type description here. Example: 
            accept (string): TODO: type description here. Example: 
            page (string, optional): TODO: type description here. Example: 
            page_size (string, optional): TODO: type description here.
                Example: 
