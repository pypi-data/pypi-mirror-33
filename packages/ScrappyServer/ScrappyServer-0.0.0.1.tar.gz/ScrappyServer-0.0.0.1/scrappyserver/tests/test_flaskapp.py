...
class TestFlaskApp(TestCase):
    ...
    def create_app(self, settings):
        app = ScrappyServer(__name__, settings=settings)
        return app
    ...
    def test_settings_dict(self):
        ...
        default_flask_app.config.from_object('scrappyserver.default_settings')
    ...
    def test_settings_abs_path(self):
        ...
        """
        abs_path = getcwd() + '/scrappyserver/tests/test_settings.py'
        ...
        flask_app.config.from_object('scrappyserver.default_settings')
