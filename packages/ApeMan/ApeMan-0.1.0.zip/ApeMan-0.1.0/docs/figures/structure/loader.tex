...
%
% C:\cygwin64\bin\convert.exe -density 600 loader.pdf -resize 360x360 loader.png
...
% Loader :
%
% This highlights the loader hook.
%
\begin{tikzpicture}
% Bounding Box
...
% Import Mechanism
\node (imp) at ($(ctr) + ( 90:6em)$) [circle, draw, inner sep = 0.1 em, minimum size=3.5 em,          ] {\lstinline|import|};
\node (fdr) at ($(ctr) + (-30:6em)$) [circle, draw, inner sep = 0.1 em, minimum size=3.5 em,          ] {\lstinline|Finder|};
\node (ldr) at ($(ctr) + (210:6em)$) [circle, draw, inner sep = 0.1 em, minimum size=3.5 em, fill=gray] {\lstinline|Loader|};
