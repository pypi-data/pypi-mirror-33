...
%
% C:\cygwin64\bin\convert.exe -density 600 finder.pdf -resize 360x360 finder.png
...
% Finder :
%
% This highlights the Finder hook.
%
\begin{tikzpicture}
% Bounding Box
...
\node (fdr) at ($(ctr) + (-30:6em)$) [circle, draw, inner sep = 0.1 em, minimum size=3.5 em, fill=gray] {\lstinline|Finder|};
