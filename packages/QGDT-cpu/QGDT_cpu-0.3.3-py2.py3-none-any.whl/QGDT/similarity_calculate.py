...
class Search2Similar(object):
    ...
    def __init__(self, search_list, w2v_path):
        ...
        self.max_sample = self._config.MAX_SAMPLE
        self.random = self._config.RANDOM
    ...
    def tmp_shuffle(self,tmp_list):
        ...
        """
        if self.random:
            random_length = random.randint(1, self.max_sample)
    ...
    def similarity_calculate(self):
        ...
        if templates_id == 1:
            for s2 in self.tmp_shuffle(templates_x1.x1_1):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x1.x1_2):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x1.x1_3):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x1.x1_4):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
        elif templates_id == 2:
            for s2 in self.tmp_shuffle(templates_x2.x1_x2_1):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x2.x1_x2_2):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x2.x1_x2_3):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x2.x1_x2_4):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
        elif templates_id == 3:
            for s2 in self.tmp_shuffle(templates_x3.x1_x2_x3_1):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x3.x1_x2_x3_2):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x3.x1_x2_x3_3):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in self.tmp_shuffle(templates_x3.x1_x2_x3_4):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
