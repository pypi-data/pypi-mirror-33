...
from QGDT.tools import get_current_path, log,tmp_shuffle
...
class Search2Similar(object):
    ...
    def similarity_calculate(self):
        ...
        if templates_id == 1:
            for s2 in tmp_shuffle(templates_x1.x1_1):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x1.x1_2):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x1.x1_3):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x1.x1_4):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
        elif templates_id == 2:
            for s2 in tmp_shuffle(templates_x2.x1_x2_1):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x2.x1_x2_2):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x2.x1_x2_3):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x2.x1_x2_4):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
        elif templates_id == 3:
            for s2 in tmp_shuffle(templates_x3.x1_x2_x3_1):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x3.x1_x2_x3_2):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x3.x1_x2_x3_3):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
            wmd_list = []
            for s2 in tmp_shuffle(templates_x3.x1_x2_x3_4):
                wmd_list.append(self.mul_wmd(s1, s2))
            min_wmd_list.append(min(wmd_list))
