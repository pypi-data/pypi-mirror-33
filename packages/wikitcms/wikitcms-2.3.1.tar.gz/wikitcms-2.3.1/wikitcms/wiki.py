...
class Wiki(mwclient.Site):
    ...
    def login(self, username=None, password=None, *args, **kwargs):
        ...
        not provided, and use openidc auth when necessary.
        """
        use_openidc = False
        ...
        if use_openidc:
            ...
            # update the site properties, and return. username and
            # password, and the credentials file, are entirely ignored
            # on this path.
        ...
        # From here on is the old code for native mediawiki auth with
        # FAS credentials. Will likely be removed in a future release.
