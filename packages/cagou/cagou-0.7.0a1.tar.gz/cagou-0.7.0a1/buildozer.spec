...
package.domain = org.salutatoi.cagou
...
garden_requirements = contextmenu, modernmenu
...
# FIXME: all is not working at the moment, it's changing orientation even when blocked in Android
#        and it crashed as soon as we move to landscade, without error message
