...
def get_api(section):
    ...
    url = cfg.get((section,'url'),default=cfg[(section,'@secrets')]['url'])
    api = tAPI(url)
    api.username = cfg.get((section,'username'),default=cfg[(section,'@secrets')]['username'])
    api.password = cfg.get((section,'password'),default=cfg[(section,'@secrets')]['password'])
