...
class WIseg(QtWidgets.QDialog, Ui_WIseg, FixedWidget):
    ...
    def connectSignals(self):
        ...
        self.device.sigStatusInfo1.connect(self.labelStatus.setText)
        self.device.sigVoltage1.connect(self.setVoltage)
        self.device.sigVoltage1.connect(self.script._setVoltage)
        self.device.sigCurrent1.connect(self.setCurrent)
        self.device.sigRamp1.connect(self.setRamp)
    ...
    def setUI(self):
        ...
        self.vplot.setXRange(-60, 0)
        self.vplot.setYRange(-2000, 2000)
        self.vplot.num = 0
        self.cplot = self.plotCurrent.addPlot()
        self.cplot.setLabel('bottom', 'Time', 's')
        self.cplot.setLabel('left', 'Current', 'A')
        self.cplot.setXRange(-60, 0)
        self.cplot.setYRange(-6e-3, 6e-3)
        self.cplot.num = 1
