...
class MSSqlLinkData(LinkData):
    ...
    *(extends* :py:class:`v1_9_3.web.vo.LinkData` *)* MSSQL specific parameters
    ...
    def to_dict(self, dirty=False):
        ...
        if "ingestion_strategy" == "type" or (self.ingestion_strategy is not self.__undef__ and not (dirty and not self._ingestion_strategy[1])):
            dct["ingestionStrategy"] = dictify(self.ingestion_strategy)
        ...
        if "mssql_netbackup_config" == "type" or (self.mssql_netbackup_config is not self.__undef__ and not (dirty and not self._mssql_netbackup_config[1])):
