...
class UnixHost(Host):
    ...
    *(extends* :py:class:`v1_9_3.web.vo.Host` *)* The representation of a Unix
    ...
    def to_dict(self, dirty=False):
        ...
        if "oracle_jdbc_keystore_password" == "type" or (self.oracle_jdbc_keystore_password is not self.__undef__ and not (dirty and not self._oracle_jdbc_keystore_password[1])):
