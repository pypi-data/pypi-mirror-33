...
class CertificateUploadParameters(TypedObject):
    ...
    *(extends* :py:class:`v1_9_2.web.vo.TypedObject` *)* The parameters for
    ...
    def to_dict(self, dirty=False):
        dct = super(CertificateUploadParameters, self).to_dict(dirty)
        ...
        if "keystore_type" == "type" or (self.keystore_type is not self.__undef__ and not (dirty and not self._keystore_type[1])):
            dct["keystoreType"] = dictify(self.keystore_type)
        if "storepass" == "type" or (self.storepass is not self.__undef__ and not (dirty and not self._storepass[1])):
