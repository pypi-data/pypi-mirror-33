...
class SplunkHecConfig(UserObject):
    ...
    *(extends* :py:class:`v1_9_2.web.vo.UserObject` *)* Splunk HTTP Event
    ...
    def to_dict(self, dirty=False):
        dct = super(SplunkHecConfig, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "main_index" == "type" or (self.main_index is not self.__undef__ and not (dirty and not self._main_index[1])):
            dct["mainIndex"] = dictify(self.main_index)
        if "hec_port" == "type" or (self.hec_port is not self.__undef__ and not (dirty and not self._hec_port[1])):
            dct["hecPort"] = dictify(self.hec_port)
        if "hec_token" == "type" or (self.hec_token is not self.__undef__ and not (dirty and not self._hec_token[1])):
        ...
        if "enable_metrics" == "type" or (self.enable_metrics is not self.__undef__ and not (dirty and not self._enable_metrics[1])):
            dct["enableMetrics"] = dictify(self.enable_metrics)
        if "enable_ssl" == "type" or (self.enable_ssl is not self.__undef__ and not (dirty and not self._enable_ssl[1])):
        ...
        if "metrics_index" == "type" or (self.metrics_index is not self.__undef__ and not (dirty and not self._metrics_index[1])):
