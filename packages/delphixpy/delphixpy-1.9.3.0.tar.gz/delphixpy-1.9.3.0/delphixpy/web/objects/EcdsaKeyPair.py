...
class EcdsaKeyPair(KeyPair):
    ...
    *(extends* :py:class:`delphixpy.web.vo.KeyPair` *)* A key pair generated
    ...
    def to_dict(self, dirty=False):
        dct = super(EcdsaKeyPair, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "key_size" == "type" or (self.key_size is not self.__undef__ and not (dirty and not self._key_size[1])):
            dct["keySize"] = dictify(self.key_size)
        if "signature_algorithm" == "type" or (self.signature_algorithm is not self.__undef__ and not (dirty and not self._signature_algorithm[1])):
