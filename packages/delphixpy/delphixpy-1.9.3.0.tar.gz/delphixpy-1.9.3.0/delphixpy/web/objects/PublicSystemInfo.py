    ...
    def to_dict(self, dirty=False):
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "vendor_phone_number" == "type" or (self.vendor_phone_number is not self.__undef__ and not (dirty and not self._vendor_phone_number[1])):
        ...
        if "vendor_url" == "type" or (self.vendor_url is not self.__undef__ and not (dirty and not self._vendor_url[1])):
        ...
        if "vendor_address" == "type" or (self.vendor_address is not self.__undef__ and not (dirty and not self._vendor_address[1])):
            dct["vendorAddress"] = dictify(self.vendor_address)
        ...
        if "support_url" == "type" or (self.support_url is not self.__undef__ and not (dirty and not self._support_url[1])):
            dct["supportURL"] = dictify(self.support_url)
        if "support_contacts" == "type" or (self.support_contacts is not self.__undef__ and not (dirty and not self._support_contacts[1])):
            dct["supportContacts"] = dictify(self.support_contacts)
        ...
        if "vendor_email" == "type" or (self.vendor_email is not self.__undef__ and not (dirty and not self._vendor_email[1])):
            dct["vendorEmail"] = dictify(self.vendor_email)
        if "engine_qualifier" == "type" or (self.engine_qualifier is not self.__undef__ and not (dirty and not self._engine_qualifier[1])):
        ...
        if "vendor_name" == "type" or (self.vendor_name is not self.__undef__ and not (dirty and not self._vendor_name[1])):
