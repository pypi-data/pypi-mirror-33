...
class MSSqlNetbackupConfig(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* MSSql NetBackup
    ...
    def to_dict(self, dirty=False):
        dct = super(MSSqlNetbackupConfig, self).to_dict(dirty)
        ...
        if "master_name" == "type" or (self.master_name is not self.__undef__ and not (dirty and not self._master_name[1])):
