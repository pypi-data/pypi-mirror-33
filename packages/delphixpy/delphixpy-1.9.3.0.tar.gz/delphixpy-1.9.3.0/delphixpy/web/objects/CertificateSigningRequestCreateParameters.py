...
class CertificateSigningRequestCreateParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters used
    ...
    def to_dict(self, dirty=False):
        dct = super(CertificateSigningRequestCreateParameters, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "dname" == "type" or (self.dname is not self.__undef__ and not (dirty and not self._dname[1])):
        ...
        if "force_replace" == "type" or (self.force_replace is not self.__undef__ and not (dirty and not self._force_replace[1])):
