...
class ASELinkedSource(ASESource):
    ...
    *(extends* :py:class:`v1_6_2.web.vo.ASESource` *)* A linked SAP ASE source.
    ...
    def to_dict(self, dirty=False):
        ...
        if "load_backup_server_name" == "type" or (self.load_backup_server_name is not self.__undef__ and not (dirty and not self._load_backup_server_name[1])):
        ...
        if "monitor_location" == "type" or (self.monitor_location is not self.__undef__ and not (dirty and not self._monitor_location[1])):
            dct["monitorLocation"] = dictify(self.monitor_location)
