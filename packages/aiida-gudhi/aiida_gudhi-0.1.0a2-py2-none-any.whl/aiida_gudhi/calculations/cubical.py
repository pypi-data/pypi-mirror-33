...
class CubicalComplexCalculation(JobCalculation):
    """
    ...
    def _init_internal_params(self):
        ...
        super(CubicalComplexCalculation, self)._init_internal_params()
    ...
    def _use_methods(cls):
        ...
        use_dict.update({
            "parameters": {
                'valid_types': CubicalComplexParameters,
    ...
    def _validate_inputs(self, inputdict):
        ...
        try:
            ...
            raise InputValidationError("No parameters specified for this "
                                       "calculation")
        if not isinstance(parameters, CubicalComplexParameters):
            raise InputValidationError("parameters not of type "
                                       "CubicalComplexParameters")
        # Check code
        try:
