...
DEFAULT_CREDENTIALS_FILE = os.path.join(os.path.expanduser("~"), '.spotinst', 'credentials')

__version__ = '1.0.28.8'
    ...
    def load_credentials(self, profile, credentials_file):
        ...
        if not self.auth_token:
            ...
            if not credentials_file:
                credentials_file = os.environ.get(VAR_SPOTINST_SHARED_CREDENTIALS_FILE, DEFAULT_CREDENTIALS_FILE)
