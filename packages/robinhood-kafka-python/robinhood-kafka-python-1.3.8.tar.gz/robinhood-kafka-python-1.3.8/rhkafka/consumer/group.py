...
class KafkaConsumer(six.Iterator):
    ...
    Arguments:
        *topics (str): optional list of topics to subscribe to. If not set,
            call :meth:`~rhkafka.KafkaConsumer.subscribe` or
            :meth:`~rhkafka.KafkaConsumer.assign` before consuming records.
    ...
    Keyword Arguments:
        ...
        max_poll_records (int): The maximum number of records returned in a
            single call to :meth:`~rhkafka.KafkaConsumer.poll`. Default: 500
    ...
    def assign(self, partitions):
        ...
        Raises:
            ...
            :meth:`~rhkafka.KafkaConsumer.subscribe`.

        Warning:
            It is not possible to use both manual partition assignment with
            :meth:`~rhkafka.KafkaConsumer.assign` and group assignment with
            :meth:`~rhkafka.KafkaConsumer.subscribe`.
    ...
    def assignment(self):
        ...
        :meth:`~rhkafka.KafkaConsumer.assign`, then this will simply return the
        same partitions that were previously assigned.  If topics were
        subscribed using :meth:`~rhkafka.KafkaConsumer.subscribe`, then this will
    ...
    def poll(self, timeout_ms=0, max_records=None):
        ...
        manually set through :meth:`~rhkafka.KafkaConsumer.seek` or automatically
        ...
        Arguments:
            ...
            max_records (int, optional): The maximum number of records returned
                in a single call to :meth:`~rhkafka.KafkaConsumer.poll`.
    ...
    def pause(self, *partitions):
        ...
        Future calls to :meth:`~rhkafka.KafkaConsumer.poll` will not return any
        records from these partitions until they have been resumed using
        :meth:`~rhkafka.KafkaConsumer.resume`.
    ...
    def paused(self):
        ...
        :meth:`~rhkafka.KafkaConsumer.pause`.
    ...
    def seek(self, partition, offset):
        ...
        :meth:`~rhkafka.KafkaConsumer.poll`. If this API is invoked for the same
        partition more than once, the latest offset will be used on the next
        :meth:`~rhkafka.KafkaConsumer.poll`.
    ...
    def subscribe(self, topics=(), pattern=None, listener=None):
        ...
        This method is incompatible with :meth:`~rhkafka.KafkaConsumer.assign`.
        ...
        Raises:
            IllegalStateError: If called after previously calling
                :meth:`~rhkafka.KafkaConsumer.assign`.
