...
class KafkaProducer(object):
    ...
    :meth:`~rhkafka.KafkaProducer.send` is asynchronous. When called it adds the
    ...
    http://rhkafka.apache.org/documentation.html#semantics
    ).
    ...
    Keyword Arguments:
        ...
        max_block_ms (int): Number of milliseconds to block during
            :meth:`~rhkafka.KafkaProducer.send` and
            :meth:`~rhkafka.KafkaProducer.partitions_for`. These methods can be
    ...
    def flush(self, timeout=None):
        ...
        post-condition of :meth:`~rhkafka.KafkaProducer.flush` is that any
