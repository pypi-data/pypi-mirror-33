...
from rhkafka.protocol.commit import GroupCoordinatorResponse, OffsetFetchRequest
...
class BrokerConnection(object):
    ...
    Keyword Arguments:
        ...
        metrics (rhkafka.metrics.Metrics): Optionally provide a metrics
    ...
    def close(self, error=None):
        ...
        Arguments:
            error (Exception, optional): pending in-flight-requests
                ...
                Default: rhkafka.errors.ConnectionError.
        """
        if self.state is ConnectionStates.DISCONNECTED:
