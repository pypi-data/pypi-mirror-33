...
from rhkafka.errors import (UnknownError, ConnectionError, FailedPayloadsError,
...
class SimpleClient(object):
    ...
    def _get_coordinator_for_group(self, group):
        ...
        # provided error
        rhkafka.errors.check_error(resp)
    ...
    def load_metadata_for_topics(self, *topics, **kwargs):
        ...
        for error, topic, partitions in resp.topics:
            ...
            if error:
                error_type = rhkafka.errors.kafka_errors.get(error, UnknownError)
