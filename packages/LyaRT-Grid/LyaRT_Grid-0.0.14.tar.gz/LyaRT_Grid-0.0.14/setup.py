...
#====================================================================#
#====================================================================#
def Check_if_DATA_files_are_found( PREFIX='' ):

    this_dir, this_filename = os.path.split(__file__)

    Bool_1 = True

    arxiv_with_file_names = this_dir + PREFIX + 'DATA/List_of_DATA_files'
    ...
    with open( arxiv_with_file_names ) as fd:
        ...
        for line in fd.readlines():
            ...
            Bool_1 = Bool_1 * os.path.isfile( this_dir + PREFIX + 'DATA/' + arxiv_name )

    return Bool_1
#====================================================================#
#====================================================================#
def Download_data( PREFIX='' ):

    this_dir, this_filename = os.path.split(__file__)

    file_were_to_store_data = this_dir + PREFIX + 'DATA/'
    ...
    try: 
        bool_data_found = Check_if_DATA_files_are_found( PREFIX='LyaRT_Grid/' )
    except:
        bool_data_found = Check_if_DATA_files_are_found( )
...
class PostDevelopCommand(develop):
    ...
    def run(self):
        ...
        try:
            Download_data( PREFIX='LyaRT_Grid/')
        except:
            Download_data()
