...
from rtox.fabric.state import env, output, win32
from rtox.fabric.auth import get_password, set_password
import rtox.fabric.network
from rtox.fabric.network import ssh, normalize
from rtox.fabric.exceptions import CommandTimeout
...
class OutputLooper(object):
    ...
    def prompt(self):
        ...
        # NOTE: Yes, the original RingBuffer from rtox.fabric can do this more elegantly.
