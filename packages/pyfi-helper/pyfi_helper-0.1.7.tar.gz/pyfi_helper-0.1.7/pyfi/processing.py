...
a = WindHelper.edb('M5567963', '2011-01-01', '2011-12-31', 'Fill = Previous')
b = WindHelper.edb('M0000545', '2012-01-01', '2018-05-30', 'Fill = Previous')
test = yoy2fixedbaseindex(a, b, option1='index', option2='yoy')
