...
name = 'ngoci'
package = 'ngoci'
description = 'Utilities for continuous integration, development workflow, and package management'
url = 'https://github.com/numengo/python-ngoci'
author='Cédric ROMAN',
...
install_requires = [
    ...
    'python-gettext',
    'click',
    'git+https://github.com/numengo/python-ngoschema',
    'ngofile',
    'tox',
    'isort',
    'yapf',
...
setup(
    ...
    zip_safe=False,
    keywords=["continuous integration", " project management", " build steps", " hooks", " docker", " test suite"], 
