...
version = ivy.__version__
# The full version, including alpha/beta/rc tags.
release = ivy.__version__
...
latex_documents = [
  ('index', 'ivy.tex', u'Ivy workflow engine Documentation',
...
man_pages = [
    ('index', 'ivy', u'Ivy workflow engine Documentation',
     [u'Joel Akeret'], 1)
]
...
texinfo_documents = [
  ('index', 'ivy', u'Ivy workflow engine Documentation',
   u'Joel Akeret', 'ivy', 'One line description of project.',
   'Miscellaneous'),
]
