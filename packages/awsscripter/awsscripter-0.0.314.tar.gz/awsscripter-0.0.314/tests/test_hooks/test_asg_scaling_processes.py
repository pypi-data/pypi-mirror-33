...
from awsscripter.common.exceptions import InvalidHookArgumentSyntaxError
from awsscripter.common.exceptions import InvalidHookArgumentTypeError
from awsscripter.common.exceptions import InvalidHookArgumentValueError
from awsscripter.hooks.asg_scaling_processes import ASGScalingProcesses
...
class TestASGScalingProcesses(object):
    ...
    @patch(
        "awsscripter.hooks.asg_scaling_processes"
