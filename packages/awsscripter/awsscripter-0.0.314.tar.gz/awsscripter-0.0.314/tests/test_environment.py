...
class TestEnvironment(object):
    ...
    def test_repr(self):
        ...
        assert response == (
            "awsscripter.environment.Environment(path='path', options='{}')"
        )

    @patch("awsscripter.environment.Environment._build")
    @patch("awsscripter.environment.Environment._check_for_circular_dependencies")
    @patch("awsscripter.environment.Environment._get_launch_dependencies")
    @patch("awsscripter.environment.Environment._get_initial_statuses")
    @patch("awsscripter.environment.Environment._get_threading_events")
    ...
    @patch("awsscripter.environment.Environment._build")
    @patch("awsscripter.environment.Environment._check_for_circular_dependencies")
    @patch("awsscripter.environment.Environment._get_delete_dependencies")
    @patch("awsscripter.environment.Environment._get_initial_statuses")
    @patch("awsscripter.environment.Environment._get_threading_events")
    ...
    @patch("awsscripter.environment.wait")
    @patch("awsscripter.environment.ThreadPoolExecutor")
    ...
    @patch("awsscripter.environment.threading.Event")
