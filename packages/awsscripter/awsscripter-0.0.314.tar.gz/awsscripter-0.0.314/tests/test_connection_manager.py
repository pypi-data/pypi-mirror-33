...
from awsscripter.common.connection_manager import ConnectionManager, _retry_boto_call
from awsscripter.common.exceptions import RetryLimitExceededError
...
class TestConnectionManager(object):
    ...
    @patch("awsscripter.connection_manager.boto3.session.Session.get_credentials")
...
class TestRetry():
    ...
    @patch("awsscripter.connection_manager.time.sleep")
