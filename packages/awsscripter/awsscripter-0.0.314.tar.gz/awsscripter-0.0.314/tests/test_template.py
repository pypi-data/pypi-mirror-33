...
import awsscripter.common.template
from awsscripter.common.connection_manager import ConnectionManager
from awsscripter.common.exceptions import TemplateSceptreHandlerError
...
class TestTemplate(object):
    ...
    def test_repr(self):
        ...
        assert representation == "awsscripter.template.Template(" \
    ...
    @patch("awsscripter.template.Template._bucket_exists")
    ...
    @patch("awsscripter.template.Template.upload_to_s3")
    ...
    @patch("awsscripter.template.Template.get_boto_call_parameter")
...
def test_render_jinja_template(filename, sceptre_user_data, expected):
    ...
    result = awsscripter.common.template.Template._render_jinja_template(
