...
class TestCli(object):
    ...
    @patch('awsscripter.cli.update.uuid1')
    @patch('awsscripter.cli.update.write')
    @pytest.mark.parametrize(
    ...
    @patch("awsscripter.cli.click.echo")
    ...
    @patch("awsscripter.cli.helpers.StackStatusColourer.colour")
    @patch("awsscripter.cli.helpers.logging.Formatter.format")
