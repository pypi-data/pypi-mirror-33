...
from awsscripter.common.exceptions import DependencyStackMissingOutputError
from awsscripter.common.exceptions import StackDoesNotExistError
from awsscripter.resolvers.stack_output import \
...
class TestStackOutputResolver(object):
    ...
    @patch(
        "awsscripter.resolvers.stack_output.StackOutput._get_output_value"
    )
...
class TestStackOutputExternalResolver(object):
    ...
    @patch(
        "awsscripter.resolvers.stack_output.StackOutputExternal._get_output_value"
    )
...
class TestStackOutputBaseResolver(object):
    ...
    @patch(
        "awsscripter.resolvers.stack_output.StackOutputBase._get_stack_outputs"
    )
