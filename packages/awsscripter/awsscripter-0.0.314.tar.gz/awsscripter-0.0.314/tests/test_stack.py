...
class TestStack(object):
    ...
    def setup_method(self, test_method):
        self.patcher_connection_manager = patch(
            "awsscripter.stack.ConnectionManager"
        )
    ...
    @patch("awsscripter.stack.Template")
    ...
    @patch("awsscripter.stack.Stack._wait_for_completion")
    ...
    @patch("awsscripter.stack.Stack.create")
    @patch("awsscripter.stack.Stack.get_status")
    ...
    @patch("awsscripter.stack.Stack.create")
    @patch("awsscripter.stack.Stack.delete")
    @patch("awsscripter.stack.Stack.get_status")
    ...
    @patch("awsscripter.stack.Stack.update")
    @patch("awsscripter.stack.Stack.get_status")
    ...
    @patch("awsscripter.stack.Stack.describe")
...
"""
    ...
    @patch("awsscripter.stack.Stack.set_policy")
    @patch("os.path.join")
    ...
    @patch("awsscripter.stack.time")
    @patch("awsscripter.stack.Stack._log_new_events")
    @patch("awsscripter.stack.Stack.get_status")
    @patch("awsscripter.stack.Stack._get_simplified_status")
    ...
    @patch("awsscripter.stack.Stack.describe_events")
    ...
    @patch("awsscripter.stack.time")
    @patch("awsscripter.stack.Stack._get_cs_status")
    ...
    @patch("awsscripter.stack.Stack.describe_change_set")
