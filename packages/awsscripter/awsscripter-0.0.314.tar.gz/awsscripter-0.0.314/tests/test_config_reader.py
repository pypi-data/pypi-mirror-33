...
from awsscripter.common.exceptions import ConfigFileNotFoundError
from awsscripter.common.exceptions import InvalidSceptreDirectoryError
from awsscripter.common.exceptions import VersionIncompatibleError


class TestConfigReader(object):
    @patch("awsscripter.config_reader.ConfigReader._check_valid_sceptre_dir")
    ...
    @patch("awsscripter.config_reader.ConfigReader._collect_s3_details")
    @patch("awsscripter.config_reader.Stack")
