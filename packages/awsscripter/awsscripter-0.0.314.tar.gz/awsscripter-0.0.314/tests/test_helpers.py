...
from awsscripter.common.helpers import camel_to_snake_case
from awsscripter.common.helpers import get_external_stack_name
from awsscripter.common.helpers import get_name_tuple
from awsscripter.common.helpers import get_subclasses
from awsscripter.common.helpers import recurse_into_sub_environments
from awsscripter.common.helpers import resolve_stack_name
from awsscripter.hooks import Hook
from awsscripter.resolvers import Resolver


class TestHelpers(object):

    def test_get_subclasses(self):
        directory = os.path.join(os.getcwd(), "awsscripter", "resolvers")
