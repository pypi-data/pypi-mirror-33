...
class Environment(object):
    ...
    ``awsscripter.helpers.recurse_into_sub_environments`` decorator.
    ...
    def __repr__(self):
        return (
            "awsscripter.environment.Environment("
    ...
    def _check_for_circular_dependencies(self):
        ...
        :raises: awsscripter.workplan.CircularDependenciesException
        """
