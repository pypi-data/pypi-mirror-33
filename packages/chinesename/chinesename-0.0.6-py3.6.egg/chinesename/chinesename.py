...
if __name__ == '__main__':
    ...
    print(cn.getName())
    print(cn.getNames(10))
    print(cn.getNameGenerator(10))

    print(cn.getBoyName())
    print(cn.getGirlName())

    print(cn.getFirstName())
    print(cn.getBoyFirstName())
    print(cn.getGirlFirstName())

    print(cn.getName(char_count=1, lastname="彭", sex="girl"))
    """     
    项炎
    ['梅榕', '田剪', '康葛', '阎焱', '杜陆', '宦感', '闾丘妇', '邰烈', '阳闵', '令狐倜']
    <generator object ChineseName.getNameGenerator at 0x1030b1a98>
    汤臧
    柳紧
    些
    那
