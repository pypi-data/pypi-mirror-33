...
class UserViewSet(viewsets.ViewSet):
    ...
    Provides get, list, update and delete operations for
    ...
    **Parameters and return value**
    ...
    :error: 401 if the request is invalid
    ...
    **Return value example of GET request**
    ...
    def partial_update(self, request, pk=None, format=None):
        ...
        validators = (is_email_valid(self.repository),
                      ...
                      is_password_length_sufficient(self.repository,
                                                    settings.MIN_PASSWORD_LENGTH),
                      does_contain_char_classes(self.repository,
                                                settings.CHAR_CLASSES))
        service = generic_update_service(self.repository,
    ...
    **Return value example of POST request**
    ...
    def create(self, request, format=None):
        ...
        validators = (is_email_valid(self.repository),
                      ...
                      does_contain_char_classes(self.repository,
                                                settings.CHAR_CLASSES))
        service = generic_create_service(self.repository,
                                         validate_many(*validators),
                                         generic_factory)
...
class TokenViewSet(viewsets.ViewSet):
    ...
    **Return value example of POST request**
    ...
    def create(self, request, format=None):
        ...
        return self._handle_error('Validation failed.',
    ...
    **Usage example for GET request**
    ...
    def list(self, request, format=None):
        ...
        if 'HTTP_AUTHORIZATION' not in request.META:
            return self._handle_error('No auth header provided.',
    ...
    **Return value example of POST request**
    ...
    def create(self, request, format=None):
        ...
        if serializer.is_valid(raise_exception=False):
            ...
            return self._refresh_token(request.user,
                                       token, refresh_token)
    ...
    **Usage example for POST request**
    ...
    def _validate_reset_token(self, reset_token, password):
        validators = (is_password_length_sufficient(self.validator_repository,
                                                    settings.MIN_PASSWORD_LENGTH),
                      does_contain_char_classes(self.validator_repository,
                                                settings.CHAR_CLASSES))
