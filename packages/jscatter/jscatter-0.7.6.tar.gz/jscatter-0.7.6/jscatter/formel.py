...
def scatteringLengthDensityCalc(composition,density=None,T=293,units='mol',mode='all'):
    ...
    composition : list of concentration + chemical formula
        ...
        E.g. '0.1C3H8O3' or '0.1C3H1D7O3' for glycerol ('D' for deuterium).
         ...
         Examples:
          ...
          - ['1.0h2o','0.1c3h8o3'] for 10% mass glycerol added to  100% h2o and units='mass'
    ...
    mode :
        ...
        - 'all'       [xsld, edensity, ncohsld, incsld, mass, massfullprotonated,
                      massfulldeuterated, d2o/h2o_fraction]
    T : float, default=293
        temperature in °K
