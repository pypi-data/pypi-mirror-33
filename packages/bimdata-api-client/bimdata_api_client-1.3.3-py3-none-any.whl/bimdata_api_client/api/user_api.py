...
class UserApi(object):
    ...
    def sign_up_with_http_info(self, sign_up_user, **kwargs):  # noqa: E501
        ...
        if ('sign_up_user' not in params or
                params['sign_up_user'] is None):
        ...
        body_params = None
        if 'sign_up_user' in params:
            body_params = params['sign_up_user']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def sign_up_with_invitation_token_with_http_info(self, invited_sign_up_user, **kwargs):  # noqa: E501
        ...
        if ('invited_sign_up_user' not in params or
                params['invited_sign_up_user'] is None):
        ...
        body_params = None
        if 'invited_sign_up_user' in params:
            body_params = params['invited_sign_up_user']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_self_user_with_http_info(self, self_user, **kwargs):  # noqa: E501
        ...
        if ('self_user' not in params or
                params['self_user'] is None):
        ...
        body_params = None
        if 'self_user' in params:
            body_params = params['self_user']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
