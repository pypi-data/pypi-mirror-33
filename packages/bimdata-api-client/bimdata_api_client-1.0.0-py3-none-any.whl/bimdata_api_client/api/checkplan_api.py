...
class CheckplanApi(object):
    ...
    def create_checker_with_http_info(self, cloud_pk, ifc_pk, project_pk, ifc_checker, **kwargs):  # noqa: E501
        ...
        if ('ifc_checker' not in params or
                params['ifc_checker'] is None):
        ...
        body_params = None
        if 'ifc_checker' in params:
            body_params = params['ifc_checker']
        # HTTP header `Accept`
    ...
    def create_checker_result_with_http_info(self, checker_pk, cloud_pk, ifc_pk, project_pk, checker_result, **kwargs):  # noqa: E501
        ...
        if ('checker_result' not in params or
                params['checker_result'] is None):
        ...
        body_params = None
        if 'checker_result' in params:
            body_params = params['checker_result']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_checkplan_with_http_info(self, cloud_pk, project_pk, check_plan, **kwargs):  # noqa: E501
        ...
        if ('check_plan' not in params or
                params['check_plan'] is None):
        ...
        body_params = None
        if 'check_plan' in params:
            body_params = params['check_plan']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_rule_component_with_http_info(self, check_plan_pk, cloud_pk, project_pk, rule_pk, ruleset_pk, rule_component, **kwargs):  # noqa: E501
        ...
        if ('rule_component' not in params or
                params['rule_component'] is None):
        ...
        body_params = None
        if 'rule_component' in params:
            body_params = params['rule_component']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
