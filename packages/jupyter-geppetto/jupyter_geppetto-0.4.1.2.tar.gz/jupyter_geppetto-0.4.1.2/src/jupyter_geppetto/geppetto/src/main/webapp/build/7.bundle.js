...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    var DrawerButton = __webpack_require__(3899);
    var Rnd = __webpack_require__(3901).default;
    ...
    var TabbedDrawer = function (_React$Component) {
        ...
        function TabbedDrawer(props) {
            ...
            _this.renderMyLabels = _this.renderMyLabels.bind(_this);
            _this.renderMyChildren = _this.renderMyChildren.bind(_this);
        ...
        _createClass(TabbedDrawer, [{
            ...
            value: function renderMyChildren() {
                var renderedComponents = this.props.children.map(function (child, index) {
                    if (this.state.drawerOpened == true) {
                        ...
                        var MyElement = this.state.selectedTab != index ? React.createElement(
                            'div',
                            { className: 'hiddenComponent', key: index },
                            React.createElement(ElementToRender, null)
                        ) : React.createElement(
                            'div',
                            { key: index },
                            React.createElement(ElementToRender, null)
                        ...
                        var MyElement = React.createElement(
                            'div',
                            { key: index },
                            React.createElement(ElementToRender, { className: 'hiddenComponent' })
                        );
                    }
                    return MyElement;
                }, this);
            ...
            value: function render() {
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        Rnd,
                        { enableResizing: { top: true, right: false, bottom: false, left: false, topRight: false,
    ...
    var DrawerButton = function (_React$Component) {
        ...
        _createClass(DrawerButton, [{
            ...
            value: function activeButton() {
                if (this.props.labelKey === this.props.selectedTab && this.props.drawerOpened) this.setState({ buttonActived: true,
                    mouseOver: false });else this.setState({ buttonActived: false,
                    mouseOver: false });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_draggable__ = __webpack_require__(3902);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_re_resizable__ = __webpack_require__(3903);
