...
def create_precursor_quant_lookup(quantdb, mzmlfn_feats, quanttype,
                                  rttol, mztol, mztoltype, fwhm=False):
    ...
    for specfn, feat_element in mzmlfn_feats:
        ...
        if fwhm:
            storefeat = (mzmlmap[specfn], feat['rt'], feat['mz'],
                         feat['charge'], feat['intensity'], feat['fwhm'])
        else:
            storefeat = (mzmlmap[specfn], feat['rt'], feat['mz'],
                         feat['charge'], feat['intensity'])
        features.append(storefeat)
