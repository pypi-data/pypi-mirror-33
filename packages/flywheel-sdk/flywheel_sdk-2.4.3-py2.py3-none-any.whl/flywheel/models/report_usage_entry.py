...
class ReportUsageEntry(object):
    ...
    def file_mbs(self, file_mbs):
        ...
        """
        if file_mbs is None:
            raise ValueError("Invalid value for `file_mbs`, must not be `None`")  # noqa: E501
    ...
    def gear_execution_count(self, gear_execution_count):
        ...
        :type: int
        """
        if gear_execution_count is None:
            raise ValueError("Invalid value for `gear_execution_count`, must not be `None`")  # noqa: E501
