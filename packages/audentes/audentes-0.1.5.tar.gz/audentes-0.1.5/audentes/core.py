    ...
    def __call__(self):
        ...
        while self.expected_response_code != response_code:
            ...
            try:
                ...
                if DEBUG:
                    print("Probing if service is open on {}".format(url))
...
class Endpoint:
    ...
    def host(self):
        ...
        if exit_code is not None:
            fail("Could not determine external port for service {} and internal port {}".format(self.service,
                                                                                                self.internal_port))
        host = output.strip()
        ...
        if DEBUG:
            print("Endpoint resolves to {}.".format(host))
