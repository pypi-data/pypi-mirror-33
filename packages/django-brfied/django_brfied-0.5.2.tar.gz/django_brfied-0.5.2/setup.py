...
setup(
    ...
    version='0.5.2',
    download_url='https://github.com/kelsoncm/django_brfied/releases/tag/0.5.2',
    ...
    classifiers=[],
    extras_require={':python_version == "2.7"': ['django_brfied==0.5.0'], ':python_version >= "3.3"': ['django_brfied==0.5.0'], },
)
