...
defaultChangelogFormat = """* Sun Jan  1 2006 John Doe <jdoe@example.com> - %s-%s
- Initial version
"""
...
class TestSimpleRpmBuild(unittest.TestCase):
    ...
    def test_add_commiter(self):
        ...
        self.rpmbuild.add_changelog_entry(message, '0.1', '1', 'Sun Jan  1 2006', commiter)
        self.rpmbuild.make()
        # FIXME: sort out architecture properly
        for arch in [expectedArch]:
            rpmFile = self.rpmbuild.get_built_rpm(arch)
