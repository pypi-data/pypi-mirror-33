...
def _create_axes(hist, vega, kwargs):
    ...
    font_size = kwargs.pop("fontsize", DEFAULT_FONTSIZE)
    vega["axes"] = [
        {"orient": "bottom", "scale": "xscale", "title": xlabel, "labelFontSize": font_size, "titleFontSize": font_size	},
        {"orient": "left", "scale": "yscale", "title": ylabel, "labelFontSize": font_size, "titleFontSize": font_size }
    ]
