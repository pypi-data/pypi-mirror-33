...
# puentes
# uploads the project to pip repositories allowing a easy installation 
#    and auto-updates of the plug-in (as usual: pip3 install qet-tb-generator) 
...
class TerminalBlock:
        ...
        for i in range(0, self.num_terminals):
            ...
            if trmnl['bridge']:
                bridge = self._line(description, x1=halfx, \
                        ...
                        y1=TerminalBlock.TERMINAL_HEIGHT / 2 + 1.5, \
                        y2=TerminalBlock.TERMINAL_HEIGHT / 2 + 1.5)
    ...
    def _label_term(self, father, x, y, text):
        ...
        y1 = y + TerminalBlock.TERMINAL_HEIGHT - 10
