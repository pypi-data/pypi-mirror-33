...
class Aggregation(object):
    ...
    def __init__(self, type=None, field=None, interval=None, format=None, metrics=None, order=None, on=None, size=None, include=None, with_geo_centroid=None, with_geo_bbox=None):
        """
