...
def momentum (cost, learning_rate, global_step, momentum = 0.99):
    return tf.train.MomentumOptimizer (learning_rate, momentum).minimize (cost, global_step = global_step)

def rmsprob (cost, learning_rate, global_step, decay = 0.9, momentum = 0.0, epsilon = 1e-10):
