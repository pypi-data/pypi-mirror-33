...
while (1):
        ...
        amp=0.1
        n=2
        motA_rf = math.cos(n*t)*amp+legpos
        motA_rb = math.sin(n*(t+3.14))*amp+legpos
        motA_lf = -(math.sin(n*(t+3.14))*amp+legpos)
        motA_lb = -(math.cos(n*t)*amp+legpos)

        motB_rf = math.cos(n*t)*amp+legpos
        motB_rb = math.sin(n*(t+3.14))*amp+legpos
        motB_lf = -(math.sin(n*(t+3.14))*amp+legpos)
        motB_lb = -(math.cos(n*t)*amp+legpos)
