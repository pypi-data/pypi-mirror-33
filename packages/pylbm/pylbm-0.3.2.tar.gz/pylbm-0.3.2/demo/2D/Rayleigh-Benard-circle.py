...
dico = {
    ...
    'elements':[pylbm.Circle([0.5*(xmin+xmax)+2*dx, 0.5*(ymin+ymax)+2*dx], .1, label=2)],
    'space_step':dx,
    'scheme_velocity':la,
    'schemes':[
        {
    ...
    'boundary_conditions':{
        ...
        1:{'method':{0: pylbm.bc.Bouzidi_bounce_back, 1: pylbm.bc.Bouzidi_anti_bounce_back}, 'value':bc_down},
        2:{'method':{0: pylbm.bc.Bouzidi_bounce_back, 1: pylbm.bc.Bouzidi_anti_bounce_back}, 'value':bc_up},
    },
    'generator': "cython",
}
