...
def extractnetstats(ID, network, thr, conn_model, est_path, mask, prune, node_size, out_file=None):
    ...
    metric_list_nodal = ['participation_coefficient', 'diversity_coefficient', 'local_efficiency', 'local_clustering', 'degree_centrality', 'betweenness_centrality', 'eigenvector_centrality', 'communicability_centrality']
