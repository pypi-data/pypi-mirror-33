...
def wb_functional_connectometry(func_file, ID, atlas_select, network, node_size, mask, thr, parlistfile, conn_model,
    ...
    wb_functional_connectometry_wf.config['logging']['log_to_file'] = 'true'
    wb_functional_connectometry_wf.config['logging']['crashfile_format'] = 'txt'
    wb_functional_connectometry_wf.config['execution']['display_variable'] = ':0'
    wb_functional_connectometry_wf.config['monitoring']['enabled'] = 'true'
...
def rsn_functional_connectometry(func_file, ID, atlas_select, network, node_size, mask, thr, parlistfile, multi_nets,
    ...
    rsn_functional_connectometry_wf.config['logging']['log_to_file'] = 'true'
    rsn_functional_connectometry_wf.config['logging']['crashfile_format'] = 'txt'
    rsn_functional_connectometry_wf.config['execution']['display_variable'] = ':0'
    rsn_functional_connectometry_wf.config['monitoring']['enabled'] = 'true'
...
def wb_structural_connectometry(ID, atlas_select, network, node_size, mask, parlistfile, plot_switch, parc, ref_txt,
    ...
    wb_structural_connectometry_wf.config['logging']['log_to_file'] = 'true'
    wb_structural_connectometry_wf.config['logging']['crashfile_format'] = 'txt'
    wb_structural_connectometry_wf.config['execution']['display_variable'] = ':0'
    wb_structural_connectometry_wf.config['monitoring']['enabled'] = 'true'
...
def rsn_structural_connectometry(ID, atlas_select, network, node_size, mask, parlistfile, plot_switch, parc, ref_txt,
    ...
    rsn_structural_connectometry_wf.config['logging']['log_to_file'] = 'true'
    rsn_structural_connectometry_wf.config['logging']['crashfile_format'] = 'txt'
    rsn_structural_connectometry_wf.config['execution']['display_variable'] = ':0'
    rsn_structural_connectometry_wf.config['monitoring']['enabled'] = 'true'
