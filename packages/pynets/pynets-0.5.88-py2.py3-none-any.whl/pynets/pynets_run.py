...
#    adapt_thresh=args.at
    ...
    def workflow_selector(input_file, ID, atlas_select, network, node_size, mask, thr, parlistfile, multi_nets,
        ...
        meta_wf.config['logging']['log_to_file'] = 'true'
        meta_wf.config['logging']['crashfile_format'] = 'txt'
    ...
    if subjects_list:
        [wf_multi, total_cores, total_ram] = wf_multi_subject(subjects_list, atlas_select, network, node_size, mask,
                                                              ...
                                                              node_size_list, num_total_samples, graph, conn_model_list)
        wb_multi.config['execution']['crashdump_dir'] = '/tmp'
        ...
        wf_multi.config['logging']['log_to_file'] = 'true'
        wf_multi.config['logging']['crashfile_format'] = 'txt'
    ...
    # Single-subject workflow generator
        ...
        wf.config['logging']['log_to_file'] = 'true'
        wf.config['logging']['crashfile_format'] = 'txt'
