...
from eostalkbase import bip38
from eostalkbase.account import PrivateKey
from eostalkbase.exceptions import (InvalidWifError, WalletExists)
    ...
    def __init__(self, steemd_instance=None, **kwargs):
        ...
        if "keys" in kwargs:
            ...
            """ If no keys are provided manually we load the SQLite
                keyStorage
            """
            from eostalkbase.storage import (keyStorage, KeyEncryptionKey)
