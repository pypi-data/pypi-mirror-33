...
def test_query_normalized_index():
    ...
    types = {
        '*':{'*': 'https://github.com/infamily/indb/wiki/dog'},
        'name':
            {'*': 'https://github.com/infamily/indb/wiki/name|lambda _:_.title()'},
        'color':
            {'*': 'https://github.com/infamily/indb/wiki/color|lambda _:_.lower()'},
        'owner':
            {'*': 'https://github.com/infamily/indb/wiki/owner|lambda _:_.lower()'},
        'skills': [
            {'*': 'https://github.com/infamily/indb/wiki/skill',
             'name': {'*': 'https://github.com/infamily/indb/wiki/name|lambda _:_.lower()'},
             'type': {'*': 'https://github.com/infamily/indb/wiki/type|lambda _:_.lower()'},
             'tests': [
                 {'*': 'https://github.com/infamily/indb/wiki/test',
                   'date': {'*': 'https://github.com/infamily/indb/wiki/date|lambda _: converters.isoparse(_).isoformat()'},
                   'level': {'*': 'https://github.com/infamily/indb/wiki/level|lambda _: int(_)'}
                  },
             ]
        }]
    }
