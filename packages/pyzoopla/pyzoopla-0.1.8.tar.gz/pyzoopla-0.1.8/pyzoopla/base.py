...
from pyzoopla.utils import currency_to_num, dist_to_num, get_station_name, text_inbetween, text_or_none, to_datetime
...
class BasePurchaseSearch(BaseSearch):
    ...
    @property
    def assumed_search_location(self):
        return text_inbetween(text=self.soup.find(name='title').text, left='Property for Sale in ', right=' - Buy')
