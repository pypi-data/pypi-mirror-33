import os
from custom_sastrawi.Dictionary.ArrayDictionary import ArrayDictionary
from custom_sastrawi.Stemmer.Stemmer import Stemmer
from custom_sastrawi.Stemmer.CachedStemmer import CachedStemmer
from custom_sastrawi.Stemmer.Cache.ArrayCache import ArrayCache

class StemmerFactory(object):
	""" Stemmer factory helps creating pre-configured stemmer """
	APC_KEY = 'custom_sastrawi_cache_dictionary'
	...
	def create_custom_stemmer(self,words):
		dictionary = ArrayDictionary(words)
		stemmer = Stemmer(dictionary)
