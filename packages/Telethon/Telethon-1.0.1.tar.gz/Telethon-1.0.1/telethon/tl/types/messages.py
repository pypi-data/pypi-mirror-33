...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDocument, TypeBotInlineResult, TypeUser, TypeStickerSet, TypeEncryptedFile, TypeDialog, TypeChatFull, TypeStickerSetCovered, TypeMessage, TypeChat, TypeHighScore, TypeStickerPack, TypeInlineBotSwitchPM, TypeFoundGif
