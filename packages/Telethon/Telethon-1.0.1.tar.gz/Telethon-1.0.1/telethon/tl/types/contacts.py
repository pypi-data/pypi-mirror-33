...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeContact, TypeImportedContact, TypePeer, TypeContactBlocked, TypePopularContact, TypeChat, TypeTopPeerCategoryPeers, TypeContactLink
