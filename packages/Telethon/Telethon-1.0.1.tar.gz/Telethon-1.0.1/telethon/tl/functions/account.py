...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureValueHash, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeInputPrivacyRule, TypeBool, TypeInputPrivacyKey, TypeReportReason, TypeInputSecureValue, TypeInputPeerNotifySettings, TypeSecureValueType, TypeAccountDaysTTL, TypeInputPeer
