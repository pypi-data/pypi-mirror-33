...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeInputChannel, TypeInputChatPhoto, TypeInputStickerSet, TypeBool, TypeChannelBannedRights, TypeChannelParticipantsFilter, TypeChannelAdminRights
