...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSendMessageAction, TypeInputSingleMedia, TypeInputMessage, TypeInputChatPhoto, TypeBool, TypeInputMedia, TypeReplyMarkup, TypeInlineBotSwitchPM, TypeMessageEntity, TypeInputStickerSet, TypeInputEncryptedChat, TypeShippingOption, TypeInputGeoPoint, TypeInputPeer, TypeInputBotInlineMessageID, TypeMessagesFilter, TypeReportReason, TypeInputDocument, TypeInputUser, TypeInputStickeredMedia, TypeInputEncryptedFile, TypeInputDialogPeer, TypeInputBotInlineResult
