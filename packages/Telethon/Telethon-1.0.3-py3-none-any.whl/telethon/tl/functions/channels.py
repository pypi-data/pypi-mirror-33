...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminLogEventsFilter, TypeBool, TypeChannelBannedRights, TypeInputChannel, TypeInputChatPhoto, TypeChannelAdminRights, TypeInputMessage, TypeInputStickerSet, TypeInputUser, TypeChannelParticipantsFilter
