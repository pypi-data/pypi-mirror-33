...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeBotInlineResult, TypeStickerSet, TypeHighScore, TypeDocument, TypeStickerSetCovered, TypeChat, TypeStickerPack, TypeUser, TypeMessage, TypeEncryptedFile, TypeChatFull, TypeFoundGif, TypeDialog
