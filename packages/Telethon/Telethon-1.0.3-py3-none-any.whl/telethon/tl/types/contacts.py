...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeTopPeerCategoryPeers, TypePeer, TypePopularContact, TypeContact, TypeChat, TypeContactLink, TypeUser, TypeContactBlocked, TypeImportedContact
