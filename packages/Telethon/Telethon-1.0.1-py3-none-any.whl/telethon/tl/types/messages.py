...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeHighScore, TypeStickerPack, TypeUser, TypeInlineBotSwitchPM, TypeChat, TypeChatFull, TypeMessage, TypeStickerSetCovered, TypeEncryptedFile, TypeBotInlineResult, TypeStickerSet, TypeDialog, TypeFoundGif, TypeDocument
