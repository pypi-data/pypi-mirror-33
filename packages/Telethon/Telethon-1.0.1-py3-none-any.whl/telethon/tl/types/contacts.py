...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeContact, TypeImportedContact, TypeTopPeerCategoryPeers, TypePopularContact, TypeChat, TypeContactLink, TypeContactBlocked, TypePeer
