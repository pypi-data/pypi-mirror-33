...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeInputChatPhoto, TypeInputMessage, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeBool, TypeChannelBannedRights, TypeChannelAdminRights, TypeChannelAdminLogEventsFilter, TypeInputUser
