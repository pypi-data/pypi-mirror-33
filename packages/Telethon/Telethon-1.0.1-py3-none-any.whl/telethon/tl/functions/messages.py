...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSingleMedia, TypeInputMessage, TypeReplyMarkup, TypeInputChatPhoto, TypeInputStickeredMedia, TypeInputEncryptedFile, TypeInlineBotSwitchPM, TypeBool, TypeReportReason, TypeInputEncryptedChat, TypeInputBotInlineResult, TypeMessageEntity, TypeInputDialogPeer, TypeInputStickerSet, TypeMessagesFilter, TypeInputUser, TypeInputMedia, TypeSendMessageAction, TypeShippingOption, TypeInputDocument, TypeInputGeoPoint, TypeInputBotInlineMessageID, TypeInputPeer
