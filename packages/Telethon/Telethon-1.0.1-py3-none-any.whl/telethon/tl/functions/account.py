...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeInputPrivacyKey, TypeAccountDaysTTL, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeInputSecureValue, TypeBool, TypeReportReason, TypeInputPrivacyRule, TypeSecureValueHash, TypeSecureValueType, TypeInputPeer
