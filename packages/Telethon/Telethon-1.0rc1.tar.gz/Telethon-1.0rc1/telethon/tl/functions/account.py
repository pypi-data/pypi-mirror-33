...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSecureValue, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeSecureValueType, TypeSecureValueHash, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeBool, TypeReportReason, TypeAccountDaysTTL, TypeInputNotifyPeer, TypeInputPeerNotifySettings
