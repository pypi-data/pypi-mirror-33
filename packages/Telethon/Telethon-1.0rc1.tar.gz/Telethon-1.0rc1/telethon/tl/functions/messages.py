...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessageEntity, TypeInputSingleMedia, TypeReplyMarkup, TypeInputBotInlineResult, TypeInputMessage, TypeInputMedia, TypeReportReason, TypeInputEncryptedChat, TypeMessagesFilter, TypeInputEncryptedFile, TypeInputUser, TypeInputDocument, TypeInputBotInlineMessageID, TypeInputPeer, TypeInputChatPhoto, TypeInlineBotSwitchPM, TypeBool, TypeInputStickerSet, TypeInputGeoPoint, TypeInputDialogPeer, TypeInputStickeredMedia, TypeShippingOption, TypeSendMessageAction
