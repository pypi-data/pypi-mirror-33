...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeInputUser, TypeChannelBannedRights, TypeInputChannel, TypeChannelParticipantsFilter, TypeInputMessage, TypeInputChatPhoto, TypeBool, TypeInputStickerSet, TypeChannelAdminLogEventsFilter
