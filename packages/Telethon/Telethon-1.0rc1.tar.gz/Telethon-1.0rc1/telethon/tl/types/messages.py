...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSetCovered, TypeHighScore, TypeStickerSet, TypeBotInlineResult, TypeChat, TypeChatFull, TypeMessage, TypeFoundGif, TypeInlineBotSwitchPM, TypeDialog, TypeEncryptedFile, TypeStickerPack, TypeDocument, TypeUser
