...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeImportedContact, TypeChat, TypePopularContact, TypePeer, TypeContactLink, TypeContactBlocked, TypeTopPeerCategoryPeers, TypeUser
