...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeChatFull, TypeUser, TypeStickerPack, TypeChat, TypeEncryptedFile, TypeDialog, TypeHighScore, TypeDocument, TypeBotInlineResult, TypeStickerSet, TypeMessage, TypeStickerSetCovered, TypeFoundGif
