...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeChat, TypeImportedContact, TypeContactBlocked, TypePeer, TypeTopPeerCategoryPeers, TypePopularContact, TypeContact, TypeContactLink
