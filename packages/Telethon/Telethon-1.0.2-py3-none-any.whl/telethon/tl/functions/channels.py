...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputUser, TypeChannelAdminRights, TypeChannelParticipantsFilter, TypeChannelBannedRights, TypeInputChatPhoto, TypeBool, TypeChannelAdminLogEventsFilter, TypeInputChannel, TypeInputStickerSet
