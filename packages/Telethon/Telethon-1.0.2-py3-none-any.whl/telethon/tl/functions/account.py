...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyRule, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeInputNotifyPeer, TypeReportReason, TypeSecureValueHash, TypeSecureCredentialsEncrypted, TypeInputSecureValue, TypeInputPeerNotifySettings, TypeSecureValueType, TypeBool, TypeInputPeer
