...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSingleMedia, TypeInputUser, TypeShippingOption, TypeInputChatPhoto, TypeInputBotInlineResult, TypeBool, TypeSendMessageAction, TypeInputEncryptedChat, TypeReplyMarkup, TypeInputGeoPoint, TypeInputMedia, TypeInputStickerSet, TypeInputMessage, TypeMessagesFilter, TypeInputDocument, TypeInputDialogPeer, TypeMessageEntity, TypeInlineBotSwitchPM, TypeInputStickeredMedia, TypeReportReason, TypeInputBotInlineMessageID, TypeInputEncryptedFile, TypeInputPeer
