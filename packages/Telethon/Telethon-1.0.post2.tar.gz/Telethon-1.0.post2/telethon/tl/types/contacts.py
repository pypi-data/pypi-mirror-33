...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypePopularContact, TypeTopPeerCategoryPeers, TypeUser, TypeContactLink, TypeImportedContact, TypeContactBlocked, TypePeer, TypeChat
