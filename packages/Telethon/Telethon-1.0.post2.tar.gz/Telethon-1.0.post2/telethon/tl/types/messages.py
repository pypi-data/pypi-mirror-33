...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessage, TypeEncryptedFile, TypeFoundGif, TypeUser, TypeDocument, TypeHighScore, TypeInlineBotSwitchPM, TypeDialog, TypeChatFull, TypeStickerSetCovered, TypeBotInlineResult, TypeStickerSet, TypeStickerPack, TypeChat
