...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedFile, TypeInputBotInlineResult, TypeInputDialogPeer, TypeInputStickeredMedia, TypeInputStickerSet, TypeInputChatPhoto, TypeReportReason, TypeShippingOption, TypeInputDocument, TypeInputMessage, TypeInputGeoPoint, TypeSendMessageAction, TypeMessageEntity, TypeInputPeer, TypeReplyMarkup, TypeMessagesFilter, TypeInputEncryptedChat, TypeInputMedia, TypeInputSingleMedia, TypeBool, TypeInputBotInlineMessageID, TypeInputUser, TypeInlineBotSwitchPM
