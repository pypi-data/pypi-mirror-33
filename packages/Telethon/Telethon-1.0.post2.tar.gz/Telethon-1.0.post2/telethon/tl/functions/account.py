...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeSecureValueType, TypeBool, TypeInputPeer, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeReportReason, TypeInputPeerNotifySettings, TypeInputSecureValue, TypeSecureValueHash
