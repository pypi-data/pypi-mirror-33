...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeInputChannel, TypeBool, TypeInputUser, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeInputMessage, TypeChannelAdminRights
