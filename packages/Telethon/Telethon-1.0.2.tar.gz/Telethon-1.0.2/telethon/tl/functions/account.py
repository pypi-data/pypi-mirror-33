...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyKey, TypeSecureCredentialsEncrypted, TypeAccountDaysTTL, TypeReportReason, TypeInputPeer, TypeInputPeerNotifySettings, TypeInputSecureValue, TypeSecureValueHash, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeSecureValueType, TypeBool
