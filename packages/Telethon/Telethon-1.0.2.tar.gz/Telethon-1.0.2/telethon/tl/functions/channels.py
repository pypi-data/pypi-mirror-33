...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeChannelBannedRights, TypeInputUser, TypeInputChannel, TypeInputStickerSet, TypeChannelAdminRights, TypeBool
