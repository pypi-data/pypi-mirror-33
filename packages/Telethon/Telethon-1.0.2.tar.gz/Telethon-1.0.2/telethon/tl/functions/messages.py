...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputEncryptedChat, TypeInputStickeredMedia, TypeInputGeoPoint, TypeInputChatPhoto, TypeReportReason, TypeSendMessageAction, TypeInputPeer, TypeInputDialogPeer, TypeInputStickerSet, TypeInlineBotSwitchPM, TypeReplyMarkup, TypeInputBotInlineMessageID, TypeBool, TypeMessagesFilter, TypeInputMedia, TypeInputUser, TypeInputDocument, TypeInputBotInlineResult, TypeMessageEntity, TypeShippingOption, TypeInputSingleMedia, TypeInputEncryptedFile
