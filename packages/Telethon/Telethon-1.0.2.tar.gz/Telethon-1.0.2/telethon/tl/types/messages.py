...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeUser, TypeDialog, TypeFoundGif, TypeMessage, TypeDocument, TypeChatFull, TypeStickerSet, TypeChat, TypeInlineBotSwitchPM, TypeStickerPack, TypeHighScore, TypeBotInlineResult, TypeStickerSetCovered
