...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePopularContact, TypeContact, TypeTopPeerCategoryPeers, TypeImportedContact, TypeUser, TypeContactBlocked, TypePeer, TypeChat, TypeContactLink
