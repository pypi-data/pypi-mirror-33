...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeStickerSetCovered, TypeStickerSet, TypeChat, TypeUser, TypeFoundGif, TypeStickerPack, TypeEncryptedFile, TypeDocument, TypeHighScore, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeChatFull, TypeMessage
