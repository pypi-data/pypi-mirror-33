...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeContactBlocked, TypeChat, TypeUser, TypeContact, TypeImportedContact, TypePeer, TypePopularContact, TypeTopPeerCategoryPeers
