...
class Chat(TLObject):
    ...
    def resolve(self, client, utils):
        if self.migrated_to:
            self.migrated_to = utils.get_input_channel(client.get_input_entity(self.migrated_to))
...
class InputDocumentFileLocation(TLObject):
    ...
    def __init__(self, id, access_hash, version):
        ...
        Constructor for InputFileLocation: Instance of either InputFileLocation, InputEncryptedFileLocation, InputDocumentFileLocation, InputSecureFileLocation.
        """
        self.id = id  # type: int
        self.access_hash = access_hash  # type: int
        self.version = version  # type: int
...
TypeInputFileLocation = Union[InputFileLocation,InputEncryptedFileLocation,InputDocumentFileLocation,InputSecureFileLocation]
