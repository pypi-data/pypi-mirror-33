...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeInputChatPhoto, TypeInputStickerSet, TypeChannelParticipantsFilter, TypeBool, TypeInputMessage, TypeChannelBannedRights, TypeInputUser, TypeChannelAdminLogEventsFilter, TypeChannelAdminRights
