...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSendMessageAction, TypeInputSingleMedia, TypeReplyMarkup, TypeInputEncryptedChat, TypeBool, TypeInputMessage, TypeInputEncryptedFile, TypeInputStickeredMedia, TypeInputBotInlineResult, TypeInputGeoPoint, TypeMessagesFilter, TypeInputUser, TypeShippingOption, TypeMessageEntity, TypeInputChatPhoto, TypeInputStickerSet, TypeInputDocument, TypeInputMedia, TypeInputBotInlineMessageID, TypeInputDialogPeer, TypeReportReason, TypeInlineBotSwitchPM, TypeInputPeer
