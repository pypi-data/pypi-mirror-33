...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSecureValue, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeSecureValueType, TypeAccountDaysTTL, TypeInputPeer, TypeSecureValueHash, TypeBool, TypeReportReason, TypeInputPeerNotifySettings, TypeSecureCredentialsEncrypted, TypeInputPrivacyKey
