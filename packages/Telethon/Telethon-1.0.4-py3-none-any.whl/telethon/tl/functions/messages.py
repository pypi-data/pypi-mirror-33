...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessageEntity, TypeMessagesFilter, TypeInputChatPhoto, TypeInputGeoPoint, TypeInlineBotSwitchPM, TypeBool, TypeInputStickeredMedia, TypeInputDocument, TypeInputUser, TypeInputEncryptedChat, TypeInputMessage, TypeReportReason, TypeInputMedia, TypeInputSingleMedia, TypeInputBotInlineResult, TypeShippingOption, TypeInputPeer, TypeInputBotInlineMessageID, TypeInputEncryptedFile, TypeReplyMarkup, TypeInputStickerSet, TypeSendMessageAction, TypeInputDialogPeer
