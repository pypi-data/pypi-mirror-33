...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeSecureCredentialsEncrypted, TypeInputPrivacyRule, TypeInputSecureValue, TypeInputPrivacyKey, TypeReportReason, TypeAccountDaysTTL, TypeSecureValueHash, TypeInputPeerNotifySettings, TypeSecureValueType, TypeBool, TypeInputNotifyPeer
