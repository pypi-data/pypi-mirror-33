...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeBotInlineResult, TypeChatFull, TypeDocument, TypeFoundGif, TypeMessage, TypeChat, TypeHighScore, TypeStickerSetCovered, TypeStickerSet, TypeEncryptedFile, TypeInlineBotSwitchPM, TypeDialog, TypeStickerPack
