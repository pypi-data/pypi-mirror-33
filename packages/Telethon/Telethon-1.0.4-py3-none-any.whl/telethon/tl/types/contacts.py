...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeUser, TypeImportedContact, TypePeer, TypeChat, TypeTopPeerCategoryPeers, TypeContact, TypeContactLink, TypePopularContact
