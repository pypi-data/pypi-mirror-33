...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeInputStickerSet, TypeChannelAdminRights, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeChannelBannedRights, TypeInputChatPhoto, TypeBool, TypeInputChannel, TypeInputUser
