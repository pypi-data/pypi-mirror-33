...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputGeoPoint, TypeInputSingleMedia, TypeInputEncryptedChat, TypeInputStickeredMedia, TypeInputMedia, TypeInputStickerSet, TypeInlineBotSwitchPM, TypeMessagesFilter, TypeInputDialogPeer, TypeShippingOption, TypeReportReason, TypeInputUser, TypeReplyMarkup, TypeInputBotInlineMessageID, TypeInputChatPhoto, TypeInputBotInlineResult, TypeSendMessageAction, TypeInputEncryptedFile, TypeInputPeer, TypeInputMessage, TypeBool, TypeMessageEntity, TypeInputDocument
