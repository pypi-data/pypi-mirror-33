...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyRule, TypeSecureValueHash, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeInputPrivacyKey, TypeAccountDaysTTL, TypeBool, TypeInputPeerNotifySettings, TypeSecureValueType, TypeReportReason, TypeInputSecureValue
