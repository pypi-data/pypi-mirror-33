...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeStickerPack, TypeUser, TypeHighScore, TypeChatFull, TypeMessage, TypeInlineBotSwitchPM, TypeFoundGif, TypeChat, TypeEncryptedFile, TypeStickerSet, TypeStickerSetCovered, TypeBotInlineResult, TypeDocument
