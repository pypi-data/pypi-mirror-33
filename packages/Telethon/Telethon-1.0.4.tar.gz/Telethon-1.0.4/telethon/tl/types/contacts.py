...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeUser, TypeTopPeerCategoryPeers, TypeImportedContact, TypePeer, TypeChat, TypeContact, TypeContactBlocked, TypePopularContact
