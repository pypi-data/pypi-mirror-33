...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatFull, TypeHighScore, TypeStickerSetCovered, TypeBotInlineResult, TypeChat, TypeStickerPack, TypeDocument, TypeEncryptedFile, TypeStickerSet, TypeInlineBotSwitchPM, TypeFoundGif, TypeDialog, TypeMessage, TypeUser
