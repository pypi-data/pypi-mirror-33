...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeContact, TypeContactLink, TypeTopPeerCategoryPeers, TypeChat, TypePeer, TypePopularContact, TypeImportedContact, TypeUser
