...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeBool, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeInputSecureValue, TypeInputPeer, TypeSecureValueHash, TypeReportReason, TypeSecureValueType
