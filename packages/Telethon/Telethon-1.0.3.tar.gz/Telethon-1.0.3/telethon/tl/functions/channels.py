...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeInputChannel, TypeChannelParticipantsFilter, TypeInputUser, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputChatPhoto, TypeBool, TypeChannelAdminRights, TypeInputMessage
