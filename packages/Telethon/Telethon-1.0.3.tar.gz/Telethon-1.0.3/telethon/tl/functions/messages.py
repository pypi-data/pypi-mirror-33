...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSingleMedia, TypeInputEncryptedFile, TypeInputEncryptedChat, TypeBool, TypeInlineBotSwitchPM, TypeInputBotInlineResult, TypeMessagesFilter, TypeInputGeoPoint, TypeInputStickeredMedia, TypeReplyMarkup, TypeInputMessage, TypeReportReason, TypeInputDocument, TypeInputStickerSet, TypeInputUser, TypeMessageEntity, TypeInputDialogPeer, TypeInputBotInlineMessageID, TypeInputMedia, TypeInputChatPhoto, TypeInputPeer, TypeShippingOption, TypeSendMessageAction
