...
static sipEncodedTypeDef supers_wxConfigBase[] = {{352, 255, 1}};
...
static sipEnumMemberDef enummembers_wxConfigBase[] = {
    {sipName_Type_Boolean, static_cast<int>( ::wxConfigBase::Type_Boolean), 80},
    {sipName_Type_Float, static_cast<int>( ::wxConfigBase::Type_Float), 80},
    {sipName_Type_Integer, static_cast<int>( ::wxConfigBase::Type_Integer), 80},
    {sipName_Type_String, static_cast<int>( ::wxConfigBase::Type_String), 80},
    {sipName_Type_Unknown, static_cast<int>( ::wxConfigBase::Type_Unknown), 80},
};
