...
static sipEncodedTypeDef supers_wxNavigationKeyEvent[] = {{136, 255, 1}};
...
static sipEnumMemberDef enummembers_wxNavigationKeyEvent[] = {
    {sipName_FromTab, static_cast<int>( ::wxNavigationKeyEvent::FromTab), 347},
    {sipName_IsBackward, static_cast<int>( ::wxNavigationKeyEvent::IsBackward), 347},
    {sipName_IsForward, static_cast<int>( ::wxNavigationKeyEvent::IsForward), 347},
    {sipName_WinChange, static_cast<int>( ::wxNavigationKeyEvent::WinChange), 347},
};
